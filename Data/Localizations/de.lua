...
L["Action"] = "Aktion";
L["Add"] = "Hinzufügen";
L["Add item rules to automatically roll need, greed or pass when a roll is announced. Rules are stored per item ID. When you win an item, its rule is automatically set to pass."] = "Füge Gegenstandsregeln hinzu, um automatisch Need, Greed oder Pass zu würfeln. Regeln werden pro Gegenstands-ID gespeichert. Beim Gewinnen wird die Regel automatisch auf Pass gesetzt.";
L["Add item rules to automatically roll need, greed or pass when a Gargul roll is announced (does not work with group loot rolls). Rules are stored per item ID. When you win an item, its rule is automatically set to pass. Shift-click items, drag them into the box below or just start typing to search."] = "Füge Gegenstandsregeln hinzu, um automatisch Need, Greed oder Pass zu würfeln, wenn ein Gargul-Wurf angekündigt wird (funktioniert nicht mit Gruppenloot-Würfen). Regeln werden pro Gegenstands-ID gespeichert. Beim Gewinnen wird die Regel automatisch auf Pass gesetzt. Shift-Klick auf Gegenstände oder ziehe sie in das Feld unten.";
L["Add rule"] = "Regel hinzufügen";
L["Auto"] = "Auto";
L["Auto Roll"] = "Auto-Wurf";
L["Enable Auto Roll"] = "Auto-Wurf aktivieren";
L["Auto roll is active ( profile: %s )"] = "Auto-Wurf aktiv ( Profil: %s )";
L["You automatically passed on %s"] = "Du hast automatisch auf %s gepasst";
L["You automatically needed on %s"] = "Du hast automatisch Need auf %s gewürfelt";
L["You automatically greeded on %s"] = "Du hast automatisch Greed auf %s gewürfelt";
L["Auto award"] = "Auto-Verleihung";
L["Automatically roll need, greed or pass based on your saved rules when a Gargul roll is announced. Does not work with group loot rolls. Manage rules via the Auto Roll Rules section or |c00A79EFF/gl autoroll|r"] = "Würfle automatisch Need, Greed oder Pass basierend auf deinen Regeln, wenn ein Gargul-Wurf angekündigt wird. Funktioniert nicht mit Gruppenloot-Würfen. Regeln unter Auto Roll Rules oder |c00A79EFF/gl autoroll|r verwalten.";
L["now supports auto rolling: |c00%s/gl ar|r or |c00%s/gl autoroll|r"] = "Gargul unterstützt jetzt automatisches Würfeln: |c00%s/gl ar|r oder |c00%s/gl autoroll|r";
L["4. Automatically roll need, greed or pass based on saved rules! Click below or use |c00A79EFF/gl ar"] = "4. Automatisch Need, Greed oder Pass würfeln! Klick unten oder |c00A79EFF/gl ar";
...
L["No rules yet. Add an item link and choose need, greed or pass."] = "Noch keine Regeln. Füge einen Gegenstandslink hinzu und wähle Need, Greed oder Pass.";
...
L["Edit"] = "Bearbeiten";
L["Softres raid"] = "Softres-Raid";
L["This item was awarded during the following Softres raid"] = "Dieser Gegenstand wurde während des folgenden Softres-Raids vergeben";
L["Enable"] = "Aktivieren";
L["Export"] = "Export";
...
L["Your rules"] = "Deine Regeln";
L["Remove all rules from this profile"] = "Alle Regeln aus diesem Profil entfernen";
L["Remove all rules from this profile?"] = "Alle Regeln aus diesem Profil entfernen?";
...
L["Item link, ID, or type to search"] = "Gegenstandslink oder ID";
...
L["Manage Auto Roll Rules"] = "Auto-Wurf-Regeln verwalten";
...
L["Remove all bids and close all auctions?"] = "Alle Gebote/Gebote entfernen und alle Auktionen schließen?";
...
L["Halt"] = "Halten";
L["Header"] = "Header";
L["v%s. Type |c00967FD2/gl|r or |c00967FD2/gargul|r to get started!"] = "v%s. Gib |c00967FD2/gl|r oder |c00967FD2/gargul|r ein, um loszulegen!";
L["Use |c00%s/gl|r to open Gargul. New to Gargul? Try |c00%s/gl start|r!"] = "Nutze |c00%s/gl|r, um Gargul zu öffnen. Neu bei Gargul? Probiere |c00%s/gl start|r!";
L["Start here"] = "Hier starten";
L["Quick start"] = "Schnellstart";
L["Back"] = "Zurück";
L["Done"] = "Fertig";
L["Open GDKP"] = "GDKP öffnen";
L["Open Softres"] = "Softres öffnen";
L["Set up"] = "Einrichten";
L["Gold runs: auction loot, split the pot."] = "Goldruns: Loot versteigern, Top teilen.";
L["Import from softres.it; see reserves on tooltips."] = "Von softres.it importieren; Reserven in Tooltips anzeigen.";
L["Send loot to players or disenchanter automatically."] = "Loot automatisch an Spieler oder Entzauberer senden.";
L["Auto need, greed or pass by rules."] = "Automatisch Need, Greed oder Pass nach Regeln.";
L["Auction loot, split the gold"] = "Loot versteigern, Gold aufteilen";
L["Auction many items at once -- the fastest way to run GDKP"] = "Viele Gegenstände gleichzeitig versteigern -- der schnellste Weg für GDKP";
L["Players reserve items before the raid"] = "Spieler reservieren Gegenstände vor dem Raid";
L["Funnel loot to the right player without clicking"] = "Loot automatisch an den richtigen Spieler verteilen";
L["Need, greed or pass without lifting a finger"] = "Need, Greed oder Pass ohne einen Finger zu rühren";
L["Total Pot"] = "Gesamtpott";
L["Soft reserved by:"] = "Soft-reserviert von:";
L["Soft Reserves"] = "Soft-Reservierungen";
L["Disenchanter"] = "Entzauberer";
L["Self"] = "Selbst";
L["Master Looter"] = "Plündermeister";
L["Epic weapons"] = "Epische Waffen";
L["Rare armor"] = "Seltene Rüstung";
L["Need"] = "Need";
L["Greed"] = "Greed";
L["Auto-rolled Need on"] = "Automatisch Need gewürfelt auf";
L["Create a session with |c00FFF569/gdkp|r"] = "Erstelle eine Sitzung mit |c00FFF569/gdkp|r";
L["Loot drops, you auction it -- gold goes into the pot"] = "Loot fällt, du versteigerst es -- Gold kommt in den Pott";
L["At the end the pot is split among all raiders"] = "Am Ende wird der Pott unter allen Raidern aufgeteilt";
L["Type |c00FFF569/gl ma|r or use the multi-auction icon in the GDKP window"] = "Gib |c00FFF569/gl ma|r ein oder nutze das Multi-Auktionssymbol im GDKP-Fenster";
L["All items are auctioned off at once -- raiders bid in real time"] = "Alle Gegenstände werden gleichzeitig versteigert -- Raider bieten in Echtzeit";
L["Recommended: auction your entire loot table in one go"] = "Empfohlen: die gesamte Loot-Tabelle auf einmal versteigern";
L["Create a raid on |c00FFF569softres.it|r"] = "Erstelle einen Raid auf |c00FFF569softres.it|r";
L["Import with |c00FFF569/gl sr|r -- data shows on all item tooltips"] = "Importiere mit |c00FFF569/gl sr|r -- Daten erscheinen in allen Tooltips";
L["Reserved items are highlighted when they drop"] = "Reservierte Gegenstände werden beim Drop hervorgehoben";
L["Reservation details are displayed when you hover over an item"] = "Reservierungsdetails werden angezeigt, wenn du über einen Gegenstand fährst";
L["Set rules by quality, name or type (e.g. greens to disenchanter)"] = "Regeln nach Qualität, Name oder Typ festlegen (z.B. Grüne an Entzauberer)";
L["Hold |c00FFF569Shift|r while looting to temporarily skip rules"] = "Halte |c00FFF569Shift|r beim Plündern, um Regeln vorübergehend zu überspringen";
L["Works with master loot and group loot"] = "Funktioniert mit Meisterplünderer und Gruppenplünderer";
L["Set up PackMule"] = "PackMule einrichten";
L["Hotkeys"] = "Hotkeys";
L["Use these on items in your bags or item links in chat"] = "Verwende diese auf Gegenstände in deinen Taschen oder Gegenstandslinks im Chat";
L["Roll / Auction"] = "Würfeln / Versteigern";
L["Award loot"] = "Loot vergeben";
L["Disenchant"] = "Entzaubern";
L["Works on items in your bags, loot windows, and chat links"] = "Funktioniert auf Gegenstände in Taschen, Loot-Fenstern und Chat-Links";
L["You can change these hotkeys in |c00FFF569/gl|r -> Shortcut Keys"] = "Du kannst diese Hotkeys ändern unter |c00FFF569/gl|r -> Shortcut Keys";
L["Try it right now -- no need to be in a raid!"] = "Probiere es jetzt aus -- kein Raid nötig!";
L["Shortcut Keys"] = "Tastenkürzel";
L["Type |c00%s/gl start|r to get back to the quick start guide"] = "Gib |c00%s/gl start|r ein, um zur Schnellstart-Anleitung zurückzukehren";
L["Set up Auto Roll"] = "Auto Roll einrichten";
L["Search for items and assign need, greed or pass per item"] = "Gegenstände suchen und Need, Greed oder Pass pro Gegenstand zuweisen";
L["When a Gargul roll is announced, your roll happens automatically"] = "Wenn ein Gargul-Wurf angekündigt wird, würfelst du automatisch";
L["Only works with Gargul rolls, not group loot"] = "Funktioniert nur mit Gargul-Würfen, nicht mit Gruppenloot";
L["Hide"] = "Ausblenden";
L["%H:%M"] = "%HM";
...
L["Only for this character"] = "Nur für diesen Charakter";
L["Other characters keep using the account-wide language"] = "Andere Charaktere verwenden weiterhin die accountweite Sprache";
...
L["Invalid item link or ID"] = "Ungültiger Gegenstandslink oder ID";
L["(BR: %s)"] = "(BR: %s)";
...
Diese Softreserves sehen nach falsch geschriebenen Namen aus.
Mit diesen Spielern in deinem Raid verknüpfen?]];
L["Choosing no imports the Softreserves unchanged"] = "Bei „Nein“ werden die Softreserves unverändert importiert";
L["'%s' could be either '%s' or '%s'"] = "Bei „%s“ könnte es sich entweder um „%s“ oder „%s“ handeln";
...
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Dein Gargul ist zu veraltet, um mit anderen zu funktionieren. Aktualisiere über CurseForge/Wago und |c00%s/reload|r!";
L["%s is trying to start a %s action, but their Gargul is too outdated. Ask them to update!"] = "%s versucht eine %s-Aktion zu starten, aber deren Gargul ist viel zu veraltet. Bitte sie zu aktualisieren!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s ist auf CurseForge/Wago verfügbar. Du kannst aktualisieren, ohne dein Spiel zu schließen. Stell einfach sicher, dass du /reload ausführst!";
