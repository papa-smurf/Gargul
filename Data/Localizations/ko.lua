...
L["Auto"] = "자동";
L["Auto Roll"] = "자동 롤";
L["Enable Auto Roll"] = "자동 롤 사용";
L["Auto roll is active ( profile: %s )"] = "자동 롤 활성 ( 프로필: %s )";
L["now supports auto rolling: |c00%s/gl ar|r or |c00%s/gl autoroll|r"] = "Gargul은 이제 자동 롤을 지원합니다: |c00%s/gl ar|r 또는 |c00%s/gl autoroll|r";
L["You automatically passed on %s"] = "%s에 자동으로 패스했습니다";
L["You automatically needed on %s"] = "%s에 자동으로 니드했습니다";
L["You automatically greeded on %s"] = "%s에 자동으로 그리드했습니다";
L["Action"] = "작업";
L["Add"] = "추가";
L["Add item rules to automatically roll need, greed or pass when a roll is announced. Rules are stored per item ID. When you win an item, its rule is automatically set to pass."] = "롤이 발표될 때 자동으로 니드, 그리드 또는 패스하도록 아이템 규칙을 추가합니다. 규칙은 아이템 ID별로 저장됩니다. 아이템을 획득하면 해당 규칙이 자동으로 패스로 설정됩니다.";
L["Add item rules to automatically roll need, greed or pass when a Gargul roll is announced (does not work with group loot rolls). Rules are stored per item ID. When you win an item, its rule is automatically set to pass. Shift-click items, drag them into the box below or just start typing to search."] = "Gargul 롤이 발표될 때 자동으로 니드, 그리드 또는 패스하도록 아이템 규칙을 추가합니다 (그룹 전리품 롤에서는 작동하지 않음). 규칙은 아이템 ID별로 저장됩니다. 아이템을 획득하면 해당 규칙이 자동으로 패스로 설정됩니다. Shift+클릭으로 아이템을 추가하거나 아래 상자로 드래그하세요.";
L["Add rule"] = "규칙 추가";
L["4. Automatically roll need, greed or pass based on saved rules! Click below or use |c00A79EFF/gl ar"] = "4. 저장된 규칙에 따라 자동으로 니드, 그리드 또는 패스! 아래를 클릭하거나 |c00A79EFF/gl ar 사용";
L["Automatically roll need, greed or pass based on your saved rules when a Gargul roll is announced. Does not work with group loot rolls. Manage rules via the Auto Roll Rules section or |c00A79EFF/gl autoroll|r"] = "Gargul 롤이 발표되면 저장된 규칙에 따라 자동으로 니드, 그리드 또는 패스합니다. 그룹 전리품 롤에서는 작동하지 않습니다. Auto Roll Rules 섹션 또는 |c00A79EFF/gl autoroll|r에서 규칙 관리";
L["No rules yet. Add an item link and choose need, greed or pass."] = "아직 규칙이 없습니다. 아이템 링크를 추가하고 니드, 그리드 또는 패스를 선택하세요.";
L["Your rules"] = "귀하의 규칙";
L["Clear all"] = "모두 지우기";
L["Remove all rules from this profile"] = "이 프로필에서 모든 규칙 제거";
L["Remove all rules from this profile?"] = "이 프로필에서 모든 규칙을 제거하시겠습니까?";
L["Item link, ID, or type to search"] = "아이템 링크 또는 ID";
L["Manage Auto Roll Rules"] = "자동 롤 규칙 관리";
L["Invalid item link or ID"] = "잘못된 아이템 링크 또는 ID";
L["(copy)"] = "(복사)";
L["A profile with that name already exists."] = "해당 이름의 프로필이 이미 존재합니다.";
...
L["Disenchant"] = "마력 추출";
L["Edit"] = "편집하다";
L["Softres raid"] = "Softres 공격대";
L["This item was awarded during the following Softres raid"] = "이 아이템은 다음 Softres 공격대에서 분배되었습니다";
L["Enable"] = "할 수 있게 하다";
L["Export"] = "내보내다";
...
L["Halt"] = "정지";
L["Header"] = "머리글";
L["v%s. Type |c00967FD2/gl|r or |c00967FD2/gargul|r to get started!"] = "v%s. 시작하려면 |c00967FD2/gl|r 또는 |c00967FD2/gargul|r을 입력하세요!";
...
L["Only for this character"] = "이 캐릭터에만 적용";
L["Other characters keep using the account-wide language"] = "다른 캐릭터는 계정 전체 언어를 계속 사용합니다";
...
L["Outdated:"] = "시대에 뒤쳐진:";
L["Up-to-date:"] = "최신 정보:";
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Gargul이 너무 오래되어 다른 사용자와 작동하지 않습니다. CurseForge/Wago에서 업데이트 후 |c00%s/reload|r 하세요!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "v|c00A79EFFv%s는 CurseForge/Wago에서 사용할 수 있습니다. 게임을 닫지 않고도 업데이트할 수 있습니다. /reload를 꼭 해주세요!";
