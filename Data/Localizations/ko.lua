...
L.HELLO = "|cff%sGargul v%s|r 작성자: Zhorax@Firemaw. 시작하려면 |cff%s/gl|r 또는 |cff%s/gargul|r을 입력하세요!";
...
L.CUT_MAIL_HISTORY = "|c00967FD2%s|r에 대한 메일 기록";
...
|c00A79EFF%s|r 가방, 전리품 창 또는 채팅 링크에 있는 항목을 이 경매 대기열에 추가할 수 있습니다.
...
|c00A79EFF/reload|r을 실행하더라도 항목은 기억됩니다.
대기 중인 항목은 Gargul을 보유한 침입자에게 자동으로 표시되므로 사전 입찰이 가능합니다.
Gargul은 자동 약탈도 처리할 수 있습니다. |c00A79EFF/gl pm|r로 확인해 보세요.
]];
...
|c00A79EFF%s|r 가방, 전리품 창 또는 채팅 링크에 있는 항목을 경매 대기열에 추가할 수 있습니다.
입찰 없이 상품을 직접 판매하고 싶으신가요? |c00A79EFF%s|r을 사용하세요.

|c00A79EFF/gl 경매|r을 입력하여 %s 창을 직접 열 수 있습니다.

Gargul은 |c00FF0000ALL|r 금 거래를 추적합니다. 이번 GDKP 세션에 거래가 포함되는 것을 원하지 않으시나요? 거래 시 'GDKP 제외' 체크박스를 체크하세요!
...
L.IMPORTED_AND_UPDATED_ON = "|c00A79EFF%s|r, |c00A79EFF%s|r에 가져옴, |c00A79EFF%s|r, |c00A79EFF%s|r에 업데이트됨";
...
L.EXPORT_READ_ONLY_NOTICE = "이는 내보내기 기능일 뿐이므로 값을 편집할 필요가 없습니다. 값이 저장되지 않습니다!\n\n";
...
L.BOOSTED_ROLLS_UPDATE_CONFIRM = "%s의 데이터로 기존 부스트 롤을 업데이트하시겠습니까?\n\n최신 업데이트는 |c00A79EFF%s|r에 있었고, 해당 업데이트는 |c00A79EFF%s|r에 있었습니다.";
L.BOOSTED_ROLLS_IMPORT_CONFIRM = "기존 부스트 롤 데이터를 지우고 %s에서 방송하는 새 데이터를 가져오시겠습니까?";
L.BOOSTED_ROLLS_IMPORT_TUTORIAL = "여기에서 CSV 또는 TSV 형식의 테이블에서 또는 Google Docs 시트에서 붙여넣은 부스트 ​​롤 데이터와 별칭을 가져올 수 있습니다.\n\n테이블에는 최소한 두 개의 열이 필요합니다. 즉, 플레이어 이름과 포인트 금액이 옵니다. 추가 열은 선택 사항이며 플레이어의 별칭을 포함할 수 있습니다.\n다음은 예제 라인입니다:\n\nFoobar,240,Barfoo";
...
L.BOOSTED_ROLLS_ADD_POINTS_CONFIRM = "현재 레이드에 있는 모든 사람에게 몇 개의 포인트를 추가합니까?\n\n|c00BE3333부스트 롤 항목이 없는 사람도 포함하여 모든 사람이 포인트를 얻도록 하려면 먼저 '누락된 레이더 추가' 버튼을 사용하세요!|r";
...
L.PLUSONES_CLEAR_CONFIRM = "플러스원 데이터를 모두 삭제하시겠습니까?";
...
L.PLUSONES_UPDATE_CONFIRM = "기존 PlusOne 데이터를 %s의 데이터로 업데이트하시겠습니까?\n\n최신 업데이트는 |c00A79EFF%s|r에 있었고 해당 업데이트는 |c00A79EFF%s|r에 있었습니다.";
...
L.SOFTRES_FEATURE_MISSING = "제공된 소프트 예약이\nsoftres.it의 'Gargul 내보내기' 버튼을 사용하여 생성되지 않았기 때문에 하드 예약 정보를 사용할 수 없습니다.";
...
L.SOFTRES_IMPORT_DETAILS = "|c00A79EFF%s|r, |c00A79EFF%s|r에서 가져옴";
...
L.SOFTRES_TOOLTIP_HARD_RESERVED_NOTE = "|c00CC2743 참고:|r %s";
...
L.TMB_TOOLTIP_TIER = "|c00FFFFFF 계층:|r %s";
L.TMB_TOOLTIP_NOTE = "|c00FFFFFF 참고:|r |cFFFFF569%s|r";
...
--[[ VERSION /gl version ]]
L.VERSION_UPDATED = "|cff%sGargul|r은 이제 |cff%sv%s|r로 업데이트되었습니다.";
...
L.VERSION_UPDATE_AVAILABLE = "v|c00A79EFFv%s|r은 CurseForge/Wago에서 사용할 수 있습니다. 게임을 닫지 않고도 업데이트할 수 있습니다. /reload를 꼭 해주세요!";
...
L.PACKMULE_AUTOLOOT_PASS_PLACEHOLDER = "통과하다";
L.PACKMULE_AUTOLOOT_GREED_PLACEHOLDER = "탐욕";
L.PACKMULE_AUTOLOOT_NEED_PLACEHOLDER = "필요";
L.PACKMULE_AUTOLOOT_IGNORE_PLACEHOLDER = "무시하다";
L.PACKMULE_AUTOLOOT_DISENCHANT_PLACEHOLDER = "드";
L.PACKMULE_AUTOLOOT_ROUND_ROBIN_PLACEHOLDER = "₩₩";
L.PACKMULE_AUTOLOOT_RANDOM_PLACEHOLDER = "무작위의";
L.PACKMULE_AUTOLOOT_SELF_PLACEHOLDER = "본인";
...
L.GDKP_CREATE_SESSION_TYPE_LABEL = "경매 유형(자세한 내용은 |c00A79EFFi|r)";
L.GDKP_CREATE_SESSION_TYPE_INFO = [[

|c00A79EFF다중 경매|r을 사용하면 한 번에 여러 항목에 대한 입찰을 시작하여 작업 속도를 높일 수 있습니다!
시작하려면 이 세션을 만든 후 지침을 따르세요.

|c00A79EFFSingle-Auction|r을 사용하면 대신 단일 항목을 경매하거나 대기열을 사용할 수 있습니다.

|c00A79EFFMulti-Auction|r을 선택하면 떨어진 항목이 대기열에 추가되지 않습니다.
|c00A79EFFMulti-Auction|r과 |c00A79EFFSingle-Auction|r 및 대기열을 혼합할 수 있지만 사용하지 않는 것이 좋습니다.
...
형식은 다음과 같습니다. 항목 ID + 최소 또는 증분이 필요합니다. (|c00BE3333헤더가 필요합니다!!|r):

|c00BE3333항목ID,최소,증분|r|c00967FD2
18608,4000,500|r
]];
...
L.GDKP_LEDGER_LEGEND_BALANCE = "잔액: |c0092FF000|r ? 당신은 정사각형입니다! | |c00BE333330|r ? 당신은 %s 30g을 빚지고 있습니다 | |c00F7922E50|r ? %s님이 당신에게 50g을 빚지고 있습니다";
L.GDKP_LEDGER_POT = "총 팟: %sg | 관리 절단: %sg(%s%%) | 배포: %sg";
L.GDKP_LEDGER_SESSION_BY = "|c00967FD2%s|r | 작성자: %s%s | |c00967FD2%s|r에";
...
L.GDKP_OVERVIEW_ADJUST_GOLD_DISABLED_TOOLTIP = "골드를 조정하려면 리드 또는 마스터 전리품이 필요합니다.\n잠김/삭제된 세션에서는 골드를 조정할 수 없습니다.";
L.GDKP_OVERVIEW_LEDGER_TOOLTIP = "원장의 전체 개요를 표시합니다.\n스크린샷 목적에 적합합니다!";
...
L.GDKP_OVERVIEW_SESSION_DETAILS = "작성자: %s%s | |c00%s%s|r%s에"; -- By name<guild> on date
L.GDKP_OVERVIEW_MUTATION_ADDED = "에 추가됨";
L.GDKP_OVERVIEW_MUTATION_REMOVED = "에서 제거됨";
L.GDKP_OVERVIEW_MUTATION_ENTRY = "|cFF%s%s|r %s 냄비: %s\n참고: %s"; -- i.e. 5000g added to pot by winner \n Note: I made a booboo
L.GDKP_OVERVIEW_AUCTION_ENTRY = "%s가 %s에 대해 |cFF%s%s|r을(를) 지불했습니다."; -- i.e. Player paid 5000g for \n [Benediction]
L.GDKP_OVERVIEW_DELETED_ENTRY = "|cFFbe3333삭제자|r %s\n이유: %s";
...
L.GDKP_OVERVIEW_DELETE_ENTRY_DISABLED_TOOLTIP = "항목을 삭제하려면 리드 또는 마스터 전리품이 필요합니다.\n잠김/삭제된 세션에서는 항목을 삭제할 수 없습니다.";
L.GDKP_OVERVIEW_RESTORE_ENTRY_DISABLED_TOOLTIP = "항목을 복원하려면 리드 또는 마스터 전리품이 필요합니다.\n잠긴/삭제된 세션의 항목은 복원할 수 없습니다.";
L.GDKP_OVERVIEW_EDIT_ENTRY_DISABLED_TOOLTIP = "항목을 편집하려면 리드 또는 마스터 전리품이 필요합니다.\n삭제된 항목이나 잠긴/삭제된 세션의 항목은 편집할 수 없습니다.";
...
L.GDKP_TUTORIAL_STEP_NEW = "첫 번째 GDKP 세션을 생성하려면 아래의 |c00FFF569New|r 버튼을 클릭하세요. 생성되면 왼쪽에 표시됩니다.";
L.GDKP_TUTORIAL_STEP_ACTIVATE = "아래의 |c00FFF569Enable|r 버튼을 클릭하여 이 세션을 활성화하세요!";
L.GDKP_TUTORIAL_STEP_READY = "아이템을 판매할 준비가 되었습니다! |c00BE3333첫 번째 GDKP 공격대를 시작하기 전에 아래의 모든 단계를 주의 깊게 읽고|r 직접 테스트해 보세요(공격대에 참가할 필요 없음)!";
L.GDKP_TUTORIAL_STEP_AUCTION = "|c00FFF569%s|r 단일 항목을 경매하거나 대기열에 추가할 항목"; -- %s holds the auction item hotkey (default ALT_CLICK)
L.GDKP_TUTORIAL_STEP_MULTI_AUCTION = "한 번에 여러 품목을 경매하고 싶으십니까? |c00FFF569/gl ma|r (또는 |c00FFF569/gl multiauction|r)을 실행하거나 이 창 오른쪽 상단에 있는 다중 경매 아이콘을 클릭하세요!";
L.GDKP_TUTORIAL_STEP_SELL = "아무도 입찰하지 않고 품목을 판매하고 싶으십니까? |c00FFF569%s|r 항목에 대해 우승자를 선택하고 가격을 설정하세요!";
L.GDKP_TUTORIAL_STEP_DONE = "모든 것이 순조롭게 진행되었다면 여기에서 새로 경매된 품목을 볼 수 있습니다!";
L.GDKP_TUTORIAL_STEP_COMMANDS = [[
유용한 명령:
- |c00FFF569/gdkp|r 이 창을 열려면
- |c00FFF569/gl ma|r 다중 경매 창 열기
- |c00FFF569/gl au|r 단일 항목 경매인/대기열을 엽니다.
- |c00FFF569/gl pm|r 자동 약탈 설정
...
L.GDKP_AUCTION_DETAILS_GOLD_ADDED = "|cFF%s%sg|r이(가) %s에 의해 냄비에 추가되었습니다\n참고: %s";
L.GDKP_AUCTION_DETAILS_GOLD_PAID_BY = "%s가 %s에 대해 |cFF%s%sg|r을(를) 지불했습니다.";
L.GDKP_AUCTION_DETAILS_DELETED_REASON = "|cFFbe3333삭제자|r %s\n이유: %s";
...
L.GDKP_BIDDER_AUTO_BID_CONFIRM = "최대 입찰가는 얼마입니까? (최소 %s|c00FFF569g|r)";
...
|c00808080한 가지 단점이 있습니다. 사람들이 일괄 경매에 참여하려면 침입자에게 Gargul이 필요합니다!|r
...
L.GDKP_MULTIAUCTION_CLIENT_REOPEN_INFO = "입찰 창이 닫혔습니다. 다시 열려면 |c00A79EFF/gl bid|r을 사용하세요!";
...
아직 판매되지 않은 모든 경매에 대한 최종 결정을 시작하세요!
]];
...
L.GDKP_MULTIAUCTION_CLIENT_SOLD_INFO = "이 품목은 판매되었습니다. 변경하려면 원장(|c00%s/gdkp|r)을 사용하세요!";
...
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_SOLD = "|c00%sSOLD|r ~\n%s(|c00%s%sg|r)";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_CLOSED = "|c00%sCLOSED\n입찰 없음|r";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_YOUR_BID = "입찰 |c00%s%sg|r\n작성자:c0092FF00YOU!|r";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_BID = "입찰 |c00%s%sg|r\n%s 기준";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_NO_BID = "최소: |c00%s%sg|r\n증분: |c00%s%sg|r";
...
L.GDKP_MUTATOR_HELP_TOOLTIP_BOTTOM = "예:\n|c00967FD2SELF,RL,HEALER|r";
...
L.GDKP_IMPORT_CUTS_INFO = "Google 시트처럼 자신의 계산에서 선수 컷을 가져올 수 있습니다. Softres GDKP 등\n\n형식은 다음과 같습니다(|c00BE3333INCLUDE THE HEADER!!|r):\n\n|c00BE3333Player,Gold|r|c00967FD2\nPlayer1,4000\nPlayer2,4125\nPlayer3,3998\n\n\n|r";
...
L.GDKP_TRADE_GIVEN_TO_LABEL = "골드 |c00967FD2|r %s에게 제공됨";
L.GDKP_TRADE_RECEIVED_FROM_LABEL = "골드 |c00967FD2|r %s에게서 받았습니다.";
...
L.GDKP_MULTIAUCTION_AUCTIONEER_SESSION_DETAILS = "활성 GDKP 세션: |c00967FD2%s|r | 작성자: %s%s | |c00967FD2%s|r에";
...
아직 거래할 수 있는 아이템을 목록에 추가하려면 아래의 |c00A79EFFF인벤토리 채우기|r 버튼을 사용하세요.
이 창을 지우고 다시 열 때마다 마지막 채우기 설정이 자동으로 항목을 추가하는 데 사용됩니다.

|c00A79EFF%s|r 항목을 수동으로 목록에 추가하려면
]];
...
--[[ BONUS FEATURES ]]
L.BONUS_AUTO_INVITE = "1. 레이드 가입 시 자동으로 그룹 초대/정렬 가능! 아래를 클릭하거나 |c00A79EFF/gl gr|r을 사용하세요.";
L.BONUS_BOOSTED_ROLLS = "2. 단골이 되거나 더 많은 노력을 기울이는 플레이어에게 보상을 주세요! 아래를 클릭하거나 |c00A79EFF/gl br|r을 사용하세요.";
L.BONUS_PLUSONES = "3. Gargul에는 플러스원 추적 시스템이 포함되어 있습니다! 아래를 클릭하거나 |c00A79EFF/gl po|r을 사용하세요.";

--[[ RAID GROUPS /gl gr ]]
L.RAIDGROUPS_EXPLANATION_LABEL_TOP = "아래의 큰 편집 상자에서 명단을 제공할 수 있으며, 모든 사람을 초대하고, 누락된 사람을 확인하고, 그룹을 적용하고 탱크를 할당할 수 있습니다.\n\n|c00FFF569와우헤드 공격대 구성|r 링크를 제공할 수 있습니다:";
L.RAIDGROUPS_EXPLANATION_LABEL_BOTTOM = "|c00FFF569Raid-Helper 내보내기|r('세로로 정렬된 그룹' 변형 사용) 또는 |c00FFF569Gargul 그룹 구성|r CSV:";
...
L.ROLLING_IDENTICAL_ROLL_WARNING = "경고: 동점을 가리킬 수 있는 또 다른 동일한 롤이 발견되었습니다|r\n\n";
...
L.MINIMAP_BUTTON_SETTING_INFO = "|r /gl 미니맵에서 설정 변경";

--[[ ASSIGN WITH GARGUL ]]
L.ASSIGN_GARGUL_INFO = "나중에 전리품을 내보내려면\n대신 Gargul을 사용하는 것을 잊지 마세요\n\n\n-- 이 창을 비활성화하려면 마우스 오른쪽 버튼을 클릭하세요 --";
