...
L["Disenchant"] = "Диз";
L["Edit"] = "ИЗМ";
L["Softres raid"] = "Рейд Softres";
L["This item was awarded during the following Softres raid"] = "Этот предмет был выдан во время следующего рейда Softres";
L["Enable"] = "ВКЛ";
L["Export"] = "ЭКСП";
...
L["Only for this character"] = "Только для этого персонажа";
L["Other characters keep using the account-wide language"] = "Другие персонажи продолжат использовать язык, установленный для всей учётной записи";
...
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Ваш Gargul слишком устарел для работы с другими. Обновите через CurseForge/Wago и |c00%s/reload|r!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s доступен на CurseForge/Wago. Вы можете обновиться, не закрывая игру, просто сделайте /reload!";
