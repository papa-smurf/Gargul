...
L.LOCALE_DEDE = "деДЕ"; -- German (Germany)
L.LOCALE_ENUS = "ruUS"; -- English (United States)
L.LOCALE_ESES = "ESES"; -- Spanish (Spain)
L.LOCALE_ESMX = "esMX"; -- Spanish (Mexico)
L.LOCALE_FRFR = "а как"; -- French (France)
L.LOCALE_ITIT = "этоИТ"; -- Italian (Italy)
L.LOCALE_KOKR = "коКР"; -- Korean (Korea)
