...
L["Are you sure you want to disenchant %s? %s boosted roll points will be refunded!"] = "Вы уверены, что хотите распылить %s? %s повышенных очков броска будут возвращены!";
L["In Group"] = "В группе";
...
L["(Given: no)"] = "(Передано: нет)";
L["(OS)"] = "(Офспек)";
L["%s boosted roll points will be refunded!"] = "%s повышенных очков броска будут возвращены!";
...
L["3. Gargul includes a plus one tracking system! Click below or use |c00A79EFF/gl po"] = "3. Гаргул включает в себя систему отслеживания плюс один! Нажмите ниже или используйте |c00A79EFF/gl po.";
L["Boosted Rolls"] = "Усиленные броски";
L["BR"] = "БР";
...
L["Nothing to broadcast, import Boosted Rolls data first!"] = "Нечего транслировать, сначала импортируйте данные Boosted Rolls!";
L["Couldn't process BoostedRolls data received from %s"] = "Не удалось обработать данные BoostedRolls, полученные от %s.";
L["Attempting to process incoming BoostedRolls data from %s"] = "Попытка обработать входящие данные BoostedRolls от %s";
L["Are you sure you want to clear all boosted roll data?"] = "Вы уверены, что хотите удалить все данные ускоренных бросков?";
L["Delete %s?"] = "Удалить %s?";
L["Are you sure you want to clear your existing boosted roll data and import new data broadcasted by %s?"] = "Вы уверены, что хотите очистить существующие данные ускоренного броска и импортировать новые данные, передаваемые %s?";
...
L["Broadcasting..."] = "Трансляция...";
L["You are currently in combat, delaying broadcast"] = "Вы сейчас в бою, трансляция задерживается.";
L["Broadcast finished!"] = "Трансляция завершена!";
L["Include awarded items"] = "Включить награжденные предметы";
L["Include disenchanted items"] = "Включить распылённые предметы";
L["Include hidden items"] = "Включить скрытые элементы";
L["Include time left"] = "Включить оставшееся время";
L["Broadcast still in progress"] = "Трансляция еще продолжается";
L["There is nothing to broadcast"] = "Нечего транслировать";
L["Number of items"] = "Количество предметов";
L["Broadcast ${percentage}%"] = "Трансляция ${percentage}%";
...
L["Close"] = "Закрыть";
L["Close on award"] = "Близко к награде";
...
L["You don't owe %s any gold"] = "Вы не должны %s золота";
L["Failed to send cut to %s"] = "Не удалось отправить фрагмент %s.";
...
L["Wait a bit, we're still processing the previous mail"] = "Подождите немного, мы все еще обрабатываем предыдущее письмо.";
...
L["All cuts were mailed!"] = "Все вырезки были отправлены по почте!";
...
L["Auto Bid"] = "Автоматическая ставка";
...
L["Min bid: %sg   Increment: %sg"] = "Минимальная ставка: %sg. Шаг: %sg.";
L["(max %sg)"] = "(макс. %sg)";
L["New bid"] = "Новая ставка";
L["Stop Auto Bid"] = "Остановить автоматическую ставку";
L["Top bid: %s by %s"] = "Максимальная ставка: %s от %s";
L["Top bid: %s by you"] = "Максимальная ставка: %s от вас";
...
L["Share (can be imported by other players)"] = "Поделиться (может быть импортирован другими игроками)";
...
L["gold mailed to the player"] = "золото отправлено игроку";
...
L["gold traded to the player"] = "золото продано игроку";
...
L["Include disenchanted items"] = "Включить распылённые предметы";
L["Pot changed"] = "Горшок изменен";
L["Gold Trades"] = "Золотые сделки";
...
L["Go back to the item selector"] = "Вернитесь к выбору элементов";
...
L["Not everyone is up-to-date. If you're experiencing issues, tell your raiders to update!"] = "Не все в курсе. Если у вас возникли проблемы, попросите своих рейдеров обновиться!";
L["There is an active multi-auction, items you add here will be added to the existing session. Be mindful of duplicate items!"] = "Существует активный мультиаукцион, предметы, которые вы сюда добавляете, будут добавлены в существующую сессию. Будьте осторожны с дублирующими товарами!";
...
L["You left during your GDKP bidding session. In order to resume it you have to provide a new bid time (in seconds) for any unsold items"] = "Вы ушли во время сессии торгов GDKP. Чтобы возобновить его, вам необходимо указать новое время ставки (в секундах) для любых непроданных товаров.";
...
L["Give a final call timer of how many seconds?"] = "Дайте таймер финального звонка на сколько секунд?";
...
L["Bidding window closed, use |c00A79EFF/gl bid to reopen it!"] = "Окно ставок закрыто. Используйте ставку |c00A79EFF/gl, чтобы открыть его снова!";
...
L["Create a new GDKP mutator"] = "Добавить новый GDKP мутатор";
L["Delete. Hold shift to bypass confirmation"] = [[Удалить мутатор.
Удерживайте Shift, чтобы удалить без подтверждения]];
L["Edit mutator"] = "Редактировать мутатор";
L["Flat gold rate [example: 250]"] = "Фикс. ставка золота [пример: 322]";
...
L["You can automatically apply this mutator to raiders using keywords:"] = "Автоматически применить этот мутатор к рейдерам, по ключевым словам:";
L["Name [example: Tanks]"] = "Название [пример: Танки]";
L["Mutator names can not contains dots (.)"] = "Имена мутаторов не могут содержать точки (.)";
...
L["Unknown mutator: %s"] = "Неизвестный мутатор: %s";
...
L["There's not enough gold to distribute, expect some weird cut calculations!"] = "Недостаточно золота для распределения, ожидайте странных расчетов!";
L["No bids!"] = "Никаких ставок!";
L["You were outbid!"] = "Ваша ставка была перебита!";
L["(active)"] = "(активная)";
...
L["Multi-auction: auction multiple items at once!"] = "Мультиаукцион: выставляйте на аукцион несколько предметов одновременно!";
L["added to"] = "Добавлено в";
L["\n|c00%s%s %s pot by %s\nNote: %s"] = [[
|c00%s%s Банк %s от %s
Примечания]]; -- i.e. 5000g added to pot by winner Note: I made a booboo
L["removed from"] = "удалено из";
...
L["Increment or minimum can't be lower than .0001!"] = "Приращение или минимум не может быть меньше 0,0001!";
L["Invalid 'Increment' provided for item ID '%s'"] = "Для идентификатора элемента «%s» указан неверный «прирост».";
L["Invalid 'Minimum' provided for item ID '%s'"] = "Для идентификатора элемента '%s' указан неверный 'Минимум'.";
L["Either minimum or increment is required for item ID: %s"] = "Для идентификатора элемента: %s требуется минимум или приращение.";
L["Missing header, note: it's case-sensitive!"] = "Отсутствует заголовок. Обратите внимание: он чувствителен к регистру!";
L["Successfully imported data for %s items"] = "Успешно импортированы данные для %s элементов.";
...
L["Check out Multi Auctions!"] = "Посетите мультиаукционы!";
...
L["Want to auction multiple items at once? Run |c00FFF569/gl ma (or |c00FFF569/gl multiauction) or click the multi-auction icon in the top right of this window!"] = [[Мультиаукцион:
...
L["Halt"] = "Остановиться";
L["Header"] = "Заголовок";
L["|c00%sGargul v%s by Zhorax@Firemaw. Type |c00%s/gl or |c00%s/gargul to get started!"] = "|c00%sГаргул v%s от Zhorax@Firemaw. Чтобы начать, введите |c00%s/gl или |c00%s/gargul!";
L["Hide"] = "Скрывать";
L["%H:%M"] = "%H:%M";
...
L["Your logo here? Click for more info!"] = "Ваш логотип здесь? Нажмите, чтобы получить дополнительную информацию!";
L["Import"] = "ИМП";
...
L["Import of boosted roll data successful"] = "Импорт данных ускоренного вращения успешен.";
L["Inc"] = "Шаг";
L["Include previously awarded items"] = "Включить ранее награжденные предметы";
...
L["ptBR"] = "птБР"; -- Portuguese (Brazil)
L["ruRU"] = "ruRU"; -- Russian (Russia)
L["zhCN"] = "жЦН"; -- Chinese (Simplified, PRC)
L["zhTW"] = "жТВ"; -- Chinese (Traditional, Taiwan)
...
L["/roll for MS or /roll 99 for OS"] = "/roll для MS или /roll 99 для ОС";
L["Import SoftRes"] = "Импортировать SoftRes";
L["Import TMB"] = "Импортировать ТМБ";
L["You were given the role of Master Looter"] = "Вам дали роль Мастера мародёра.";
...
L["Mail"] = "Почта";
L["Mailed"] = "По почте";
L["Mail cut to players"] = "Отказ почты игрокам";
L["MS"] = "MS";
...
L["Ok"] = "ОК";
L["Open"] = "Открыть";
L["Open Auctioneer"] = "Открытый аукционист";
L["Open Multi-Auction"] = "Открытый мультиаукцион";
L["DE"] = "DE";
L["GREED"] = "GREED";
L["IGNORE"] = "IGNORE";
L["NEED"] = "NEED";
...
L["RR"] = "RR";
L["SELF"] = "SELF";
L["Set %s as your disenchanter?"] = "Назначить %s своим распылителем?";
L["Send %s to %s? Type /gl cd to remove this disenchanter!"] = "Отправить %s %s? Введите /gl cd, чтобы удалить этот дисчантер!";
L["No disenchanter set, use /gl sd [mydisenchanter] to set one"] = "Нет набора распылителей, используйте /gl sd [mydisenchanter], чтобы установить его.";
L["Who is your disenchanter?"] = "Кто твой распылитель?";
L["Paid"] = "Потратил";
L["Pass"] = "Пас";
L["%"] = "%";
L["Player"] = "Игрок";
...
L["Are you sure you want to broadcast your plus one data to everyone in your party/raid?"] = "Вы уверены, что хотите передать данные плюс один всем в вашей группе/рейде?";
...
L["Automatically accept incoming broadcasts from %s"] = "Автоматически принимать входящие трансляции от %s";
L["Block all incoming +1 shared data"] = "Блокировать все входящие общие данные +1";
...
L["Disband raid"] = "Расформировать рейд";
L["Disband your raid"] = "Расформировать свой рейд";
...
L["No tanks defined"] = "Танки не определены";
L["Can't find a place for %s, are you trying to put more than 5 people in 1 group?"] = "Не можете найти место для %s. Вы пытаетесь объединить более 5 человек в 1 группу?";
L["Kick unwanted players"] = "Выкидывайте нежелательных игроков";
L["Kick players that aren't on the roster"] = "Выкидывать игроков, которых нет в списке";
...
L["Sorting groups"] = "Сортировочные группы";
L["Apply Groups"] = "Применить группы";
L["Sort groups based on roster"] = "Сортировка групп по списку";
L["Sorting is still in progress, wait a bit!"] = "Сортировка еще продолжается, подождите немного!";
L["All tanks are assigned"] = "Все танки распределены";
L["Assign Tanks"] = "Назначьте танки";
...
L["Reset Gargul UI"] = "Сбросить пользовательский интерфейс Гаргула";
...
L["Invalid data provided for roll start!"] = "Для начала старта предоставлены неверные данные!";
L["(BR: %s)"] = "(БР: %s)";
L["(item given: yes)"] = "(данный пункт: да)";
L["(item given: no)"] = "(данный пункт: нет)";
L["(OS)"] = "(ОПЕРАЦИОННЫЕ СИСТЕМЫ)";
L["NOTE"] = "ПРИМЕЧАНИЕ";
L["Can't stop roll off, no roll off in progress"] = "Не могу остановить скатывание, скатывание не происходит.";
L["Pass"] = "Проходить";
L["rolls: %s"] = "бросков: %s";
L["Open master looter window"] = "Открыть главное окно мародёра";
L["Roll accepted!"] = "Ролл принят!";
L["A roll is currently in progress"] = "В настоящее время идет проверка";
L["Prio [%s]"] = "Прио [%s]";
L["SR [%sx]"] = "СР [%sx]";
L["Wish [%s]"] = "Желаю [%s]";
...
L["The winner's name is not unique, select the player you'd like to award %s to"] = "Имя победителя не уникально. Выберите игрока, которому вы хотите наградить %s.";
L["s"] = "с";
L["Select / Disable all"] = "Выбрать/снять выбор";
L["Session"] = "Сессия";
L["Settings"] = "Настройки";
L["Announce incoming bids"] = "Объявить о поступивших ставках";
L["Announce pot after awarding item"] = "Объявить банк после вручения предмета";
L["Announce auction start"] = "Объявить о начале аукциона";
L["Announce countdown in raid warning"] = "Объявить обратный отсчет в предупреждении о рейде";
L["Announce incoming bids in raid warning"] = "Объявляйте о входящих ставках в предупреждении о рейде";
L["Reset Gargul UI"] = "Сбросить пользовательский интерфейс Гаргула";
L["Whisper bidder if bid is too low"] = "Сообщите участнику торгов, если ставка слишком низкая";
L["s"] = "с";
L["Skip"] = "Пропускать";
L["Soft-Reserves"] = "Мягкие резервы";
L["SR"] = "СР";
L["Are you sure you want to broadcast your softres data to everyone in your party/raid?"] = "Вы уверены, что хотите передать данные программного обеспечения всем членам вашей группы/рейда?";
L["Couldn't process SoftRes data received from %s"] = "Не удалось обработать данные SoftRes, полученные от %s.";
L["Are you sure you want to clear all existing soft-reserve data?"] = "Вы уверены, что хотите удалить все существующие данные мягкого резервирования?";
L["Everyone filled out their soft-reserves"] = "Все пополнили свои мягкие резервы";
...
L["Invalid soft-reserve data provided"] = "Предоставлены неверные данные мягкого резерва.";
...
L["Soft-reserves imported successfully"] = "Мягкие резервы успешно импортированы";
...
L["Click here to see hard-reserve info"] = "Нажмите здесь, чтобы просмотреть информацию о жестком резерве";
L["No items are hard-reserved"] = "Ни один элемент не зарезервирован жестко";
L["No hard-reserve info available"] = "Информация о жестком резерве отсутствует.";
...
L["This item is hard-reserved"] = "Этот предмет жестко зарезервирован";
L["For: %s"] = "Для: %s";
L["|c00CC2743 Note: %s"] = "|c00CC2743 Примечание: %s";
...
L["Time"] = "Время";
L["Title"] = "Заголовок";
L["TMB, DFT or PRIO3"] = "ТМБ, ДФТ или ПРИО3";
...
L["Number of items imported: %s"] = "Количество импортированных товаров: %s";
...
L["|c00FFFFFF    Note: |c00FFF569%s"] = "|c00FFFFFF Примечание: |c00FFF569%s";
L["(OS)"] = "(ОПЕРАЦИОННЫЕ СИСТЕМЫ)";
L["%s Prio List"] = "%s список приоритетов"; -- %s can be TMB/DFT/CPR
L["|c00FFFFFF    Tier: %s"] = "|c00FFFFFF Уровень: %s";
L["TMB Wish List"] = "Список желаний ТМБ";
...
L["Announce Trade"] = "Объявить о торговле";
L["Announce trade details to group or in /say when not in a group"] = "Объявляйте детали сделки группе или в /say, когда вы не в группе.";
...
L["Update Gargul!"] = "Обновите Гаргул!";
L["|c00%sGargul is now updated to |c00%sv%s"] = "|c00%sGargul теперь обновлен до |c00%sv%s";
...
L["Wait %s more seconds before you retry"] = "Подождите еще %s секунд, прежде чем повторить попытку.";
L["Window"] = "Окно";
L["Gargul v%s"] = "Гаргул против %s";
