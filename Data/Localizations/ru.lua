...
L.AWARDED_TOOLTIP_GIVEN = "Передано: да";
L.AWARDED_TOOLTIP_NOT_GIVEN = "Передано: нет";
...
L.AWARD_NEW_WINNER_CONFIRMATION = "Кому передать %s?";
L.AWARD_PLAYER_CUSTOM_NAME = "Введите здесь имя игрока";
L.AWARD_PLAYER_SELECT_NAME = "или выберите один ниже";
L.AWARD_RANDOM_CONFIRM = "Вы хотите отдать %s случайному игроку?";
L.AWARD_TOOLTIP_ADD_ITEM = "Перетащите или нажмите Shift+ЛКМ на предмет в поле справа.";
L.AWARD_TOOLTIP_BR_INDICATION = "(БР: %s)";
L.AWARD_TOOLTIP_DISENCHANTED_ITEMS = "Распылённые предметы:";
L.AWARD_TOOLTIP_GIVEN = "(Передано: да)";
L.AWARD_TOOLTIP_NOT_GIVEN = "(Передано: нет)";
L.AWARD_TOOLTIP_OFFSPEC_INDICATION = "(Офспек)";
...
L.BOOSTED_ROLLS_ADD_POINTS_ERROR = "Стоимость в баллах не указана!";
L.BOOSTED_ROLLS_ADD_POINTS_TO_RAID_BUTTON = "Добавить очки рейду";
...
L.BROADCAST_INC_DISENCHANTED = "Включить распылённые предметы";
...
L.CUT_MAIL_SUBJECT = "Гаргул GDKP: %sg";
...
L.GARGUL = "Гаргул";
L.GDKP = "GDKP";
L.GDKPS_ARE_NOT_ALLOWED = "Рейды GDKP не разрешены в этой версии World of Warcraft.";
L.GDKP_ACTIVATED = "GDKP активен!";
...
L.MINIMAP_BUTTON_CUTS = "GDKP срезы";
...
L.TRADETIME_SETTINGS_HIDE_DISENCHANTED = "Скрыть распылённые предметы";
...
L.VERSION_UPDATE_AVAILABLE = "|c00A79EFFv%s доступен на CurseForge/Wago. Вы можете обновиться, не закрывая игру, просто сделайте /reload!";
