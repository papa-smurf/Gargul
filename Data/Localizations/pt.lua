...
L["Auctions"] = "Leilões";
L["Auto"] = "Auto";
L["Auto Roll"] = "Rolagem automática";
L["Enable Auto Roll"] = "Ativar rolagem automática";
L["Auto roll is active ( profile: %s )"] = "Rolagem automática ativa ( perfil: %s )";
L["now supports auto rolling: |c00%s/gl ar|r or |c00%s/gl autoroll|r"] = "Gargul agora suporta rolagem automática: |c00%s/gl ar|r ou |c00%s/gl autoroll|r";
L["You automatically passed on %s"] = "Você passou automaticamente em %s";
L["You automatically needed on %s"] = "Você rolou Need automaticamente em %s";
L["You automatically greeded on %s"] = "Você rolou Greed automaticamente em %s";
L["Action"] = "Ação";
L["Add"] = "Adicionar";
L["Add item rules to automatically roll need, greed or pass when a roll is announced. Rules are stored per item ID. When you win an item, its rule is automatically set to pass."] = "Adicione regras para rolar automaticamente need, greed ou pass. As regras são armazenadas por ID de item. Quando você ganha um item, sua regra passa automaticamente para pass.";
L["Add item rules to automatically roll need, greed or pass when a Gargul roll is announced (does not work with group loot rolls). Rules are stored per item ID. When you win an item, its rule is automatically set to pass. Shift-click items, drag them into the box below or just start typing to search."] = "Adicione regras para rolar automaticamente need, greed ou pass quando um roll Gargul é anunciado (não funciona com rolls de saque de grupo). As regras são armazenadas por ID. Quando você ganha um item, sua regra passa a pass. Shift+clique nos itens ou arraste-os para a caixa abaixo.";
L["Add rule"] = "Adicionar regra";
L["4. Automatically roll need, greed or pass based on saved rules! Click below or use |c00A79EFF/gl ar"] = "4. Role automaticamente need, greed ou pass com base nas regras salvas! Clique abaixo ou use |c00A79EFF/gl ar";
L["Automatically roll need, greed or pass based on your saved rules when a Gargul roll is announced. Does not work with group loot rolls. Manage rules via the Auto Roll Rules section or |c00A79EFF/gl autoroll|r"] = "Role automaticamente need, greed ou pass com base nas suas regras quando um roll Gargul é anunciado. Não funciona com rolls de saque de grupo. Gerencie as regras na seção Auto Roll Rules ou |c00A79EFF/gl autoroll|r";
L["No rules yet. Add an item link and choose need, greed or pass."] = "Ainda sem regras. Adicione um link de item e escolha need, greed ou pass.";
L["Your rules"] = "Suas regras";
L["Clear all"] = "Limpar tudo";
L["Remove all rules from this profile"] = "Remover todas as regras deste perfil";
L["Remove all rules from this profile?"] = "Remover todas as regras deste perfil?";
L["Item link, ID, or type to search"] = "Link ou ID do item";
L["Manage Auto Roll Rules"] = "Gerenciar regras de rolagem automática";
L["Invalid item link or ID"] = "Link ou ID de item inválido";
L["(copy)"] = "(cópia)";
...
L["Delete profile \"%s\"?"] = "Excluir perfil \"%s\"?";
L["No profile"] = "Sem perfil";
...
L["Edit"] = "Editar";
L["Softres raid"] = "Raide do Softres";
L["This item was awarded during the following Softres raid"] = "Este item foi distribuído durante o seguinte raide do Softres";
L["Enable"] = "Habilitar";
L["Export"] = "Exportar";
L["Export session"] = "Exportar sessão";
...
L["Remove all bids and close all auctions?"] = "Remover todos os lances e fechar todos os leilões?";
...
L["Halt"] = "Parar";
L["Header"] = "Cabeçalho";
L["v%s. Type |c00967FD2/gl|r or |c00967FD2/gargul|r to get started!"] = "v%s. Digite |c00967FD2/gl|r ou |c00967FD2/gargul|r para começar!";
L["Use |c00%s/gl|r to open Gargul. New to Gargul? Try |c00%s/gl start|r!"] = "Use |c00%s/gl|r to open Gargul. New to Gargul? Try |c00%s/gl start|r!";
L["Start here"] = "Start here";
L["Quick start"] = "Quick start";
L["Back"] = "Back";
L["Done"] = "Done";
L["Open GDKP"] = "Open GDKP";
L["Open Softres"] = "Open Softres";
L["Set up"] = "Set up";
L["Gold runs: auction loot, split the pot."] = "Gold runs: auction loot, split the pot.";
L["Import from softres.it; see reserves on tooltips."] = "Import from softres.it; see reserves on tooltips.";
L["Send loot to players or disenchanter automatically."] = "Send loot to players or disenchanter automatically.";
L["Auto need, greed or pass by rules."] = "Auto need, greed or pass by rules.";
L["Auction loot, split the gold"] = "Auction loot, split the gold";
L["Auction many items at once -- the fastest way to run GDKP"] = "Auction many items at once -- the fastest way to run GDKP";
L["Players reserve items before the raid"] = "Players reserve items before the raid";
L["Funnel loot to the right player without clicking"] = "Funnel loot to the right player without clicking";
L["Need, greed or pass without lifting a finger"] = "Need, greed or pass without lifting a finger";
L["Total Pot"] = "Total Pot";
L["Soft reserved by:"] = "Soft reserved by:";
L["Soft Reserves"] = "Soft Reserves";
L["Disenchanter"] = "Disenchanter";
L["Self"] = "Self";
L["Master Looter"] = "Master Looter";
L["Epic weapons"] = "Epic weapons";
L["Rare armor"] = "Rare armor";
L["Need"] = "Need";
L["Greed"] = "Greed";
L["Auto-rolled Need on"] = "Auto-rolled Need on";
L["Create a session with |c00FFF569/gdkp|r"] = "Create a session with |c00FFF569/gdkp|r";
L["Loot drops, you auction it -- gold goes into the pot"] = "Loot drops, you auction it -- gold goes into the pot";
L["At the end the pot is split among all raiders"] = "At the end the pot is split among all raiders";
L["Type |c00FFF569/gl ma|r or use the multi-auction icon in the GDKP window"] = "Type |c00FFF569/gl ma|r or use the multi-auction icon in the GDKP window";
L["All items are auctioned off at once -- raiders bid in real time"] = "All items are auctioned off at once -- raiders bid in real time";
L["Recommended: auction your entire loot table in one go"] = "Recommended: auction your entire loot table in one go";
L["Create a raid on |c00FFF569softres.it|r"] = "Create a raid on |c00FFF569softres.it|r";
L["Import with |c00FFF569/gl sr|r -- data shows on all item tooltips"] = "Import with |c00FFF569/gl sr|r -- data shows on all item tooltips";
L["Reserved items are highlighted when they drop"] = "Reserved items are highlighted when they drop";
L["Reservation details are displayed when you hover over an item"] = "Reservation details are displayed when you hover over an item";
L["Set rules by quality, name or type (e.g. greens to disenchanter)"] = "Set rules by quality, name or type (e.g. greens to disenchanter)";
L["Hold |c00FFF569Shift|r while looting to temporarily skip rules"] = "Hold |c00FFF569Shift|r while looting to temporarily skip rules";
L["Works with master loot and group loot"] = "Works with master loot and group loot";
L["Set up PackMule"] = "Set up PackMule";
L["Hotkeys"] = "Hotkeys";
L["Use these on items in your bags or item links in chat"] = "Use these on items in your bags or item links in chat";
L["Roll / Auction"] = "Roll / Auction";
L["Award loot"] = "Award loot";
L["Disenchant"] = "Disenchant";
L["Works on items in your bags, loot windows, and chat links"] = "Works on items in your bags, loot windows, and chat links";
L["You can change these hotkeys in |c00FFF569/gl|r -> Shortcut Keys"] = "You can change these hotkeys in |c00FFF569/gl|r -> Shortcut Keys";
L["Try it right now -- no need to be in a raid!"] = "Try it right now -- no need to be in a raid!";
L["Shortcut Keys"] = "Shortcut Keys";
L["Type |c00%s/gl start|r to get back to the quick start guide"] = "Type |c00%s/gl start|r to get back to the quick start guide";
L["Set up Auto Roll"] = "Set up Auto Roll";
L["Search for items and assign need, greed or pass per item"] = "Search for items and assign need, greed or pass per item";
L["When a Gargul roll is announced, your roll happens automatically"] = "When a Gargul roll is announced, your roll happens automatically";
L["Only works with Gargul rolls, not group loot"] = "Only works with Gargul rolls, not group loot";
L["Hide"] = "Esconder";
L["%H:%M"] = "%H:%M";
...
L["Only for this character"] = "Somente para este personagem";
L["Other characters keep using the account-wide language"] = "Os outros personagens continuam usando o idioma da conta";
...
Estas Softreserves parecem nomes escritos incorretamente.
Vinculá-las a estes jogadores da sua raide?]];
L["Choosing no imports the Softreserves unchanged"] = "Ao escolher Não, as Softreserves são importadas sem alterações";
L["'%s' could be either '%s' or '%s'"] = "'%s' pode ser '%s' ou '%s'";
...
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Seu Gargul está muito desatualizado para funcionar com outros. Atualize via CurseForge/Wago e |c00%s/reload|r!";
L["%s is trying to start a %s action, but their Gargul is too outdated. Ask them to update!"] = "%s está tentando iniciar uma ação de %s, mas o Gargul dele está muito desatualizado. Peça para atualizar!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s está disponível em CurseForge/Wago. Você pode atualizar sem fechar o jogo, apenas certifique-se de /reload !";
