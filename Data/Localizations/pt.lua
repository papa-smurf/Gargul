...
L.TMB_IMPORT_TMB_GARGUL_INFO = "Como usar Gargul com ${source}";
...
L.VERSION_UPDATE_AVAILABLE = "|c00A79EFFv%s está disponível em CurseForge/Wago. Você pode atualizar sem fechar o jogo, apenas certifique-se de /reload !";
