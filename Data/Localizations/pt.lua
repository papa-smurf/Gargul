...
L.HELLO = "|cff%sGargul v%s|r por Zhorax@Firemaw. Digite |cff%s/gl|r ou |cff%s/gargul|r para começar!";
...
L.CUT_MAIL_HISTORY = "Histórico de e-mail para |c00967FD2%s|r";
...
|c00A79EFF%s|r itens em bolsas, janelas de saque ou até mesmo em links no seu chat para adicioná-los a esta fila de leilão.
...
|c00FFF569Você sabia?|r
Você pode mover itens arrastando e soltando
Os itens serão lembrados, mesmo quando você |c00A79EFF/reload|r
Os itens na fila são mostrados automaticamente aos invasores que possuem Gargul para que possam pré-oferecer
Gargul também pode cuidar do saque automático para você. Confira com |c00A79EFF/gl pm|r
]];
...
|c00A79EFF%s|r itens em bolsas, janelas de saque ou até mesmo em links no seu chat para adicioná-los à fila do leilão.
Quer vender um item diretamente sem licitar? Usar |c00A79EFF%s|r

Você pode abrir a janela %s diretamente digitando |c00A79EFF/gl leilão|r

Gargul rastreia |c00FF0000ALL|r ouro negociado. Não quer que uma negociação faça parte desta sessão do GDKP? Marque a caixa de seleção 'Excluir do GDKP' ao negociar!
...
L.HEADER = "Cabeçalho";
L.FORMAT = "Formatar";
L.TAB_REPLACES_T = "\t é substituído por uma guia";
L.DATE_FORMAT = "%Y-%m-%d";
...
L.IMPORTED_AND_UPDATED_ON = "Importado em |c00A79EFF%s|r em |c00A79EFF%s|r, atualizado em |c00A79EFF%s|r em |c00A79EFF%s|r";
...
L.EXPORT_READ_ONLY_NOTICE = "Este é APENAS um recurso de exportação, não faz sentido editar nenhum dos valores: ELES NÃO SERÃO SALVOS!\n\n";
...
L.BOOSTED_ROLLS_UPDATE_CONFIRM = "Tem certeza de que deseja atualizar suas listas otimizadas existentes com dados de %s?\n\nSua atualização mais recente foi em |c00A79EFF%s|r, a deles em |c00A79EFF%s|r.";
...
L.BOOSTED_ROLLS_IMPORT_TUTORIAL = "Aqui você pode importar dados de lançamento otimizado e aliases de uma tabela em formato CSV ou TSV ou colados de uma planilha do Google Docs.\n\nA tabela precisa de pelo menos duas colunas: O nome do jogador seguido pela quantidade de pontos. Colunas adicionais são opcionais e podem conter apelidos para o player.\nAqui está um exemplo de linha:\n\nFoobar,240,Barfoo";
...
L.BOOSTED_ROLLS_ADD_POINTS_CONFIRM = "Adicionar quantos pontos para todos que estão atualmente na raid?\n\n|c00BE3333Use o botão 'Adicionar raiders ausentes' primeiro se quiser que todos ganhem pontos, mesmo aqueles sem uma entrada de rolagem aprimorada!|r";
...
L.PLUSONES_CLEAR_CONFIRM = "Tem certeza de que deseja limpar todos os dados mais um?";
...
L.PLUSONES_UPDATE_CONFIRM = "Tem certeza de que deseja atualizar seus dados PlusOne existentes com dados de %s?\n\nSua atualização mais recente foi em |c00A79EFF%s|r, a deles em |c00A79EFF%s|r.";
...
L.SOFTRES_FEATURE_MISSING = "As informações de reserva definitiva não estão disponíveis porque as reservas temporárias\nfornecidas não foram geradas usando o botão 'Exportar Gargul' em softres.it";
...
L.SOFTRES_IMPORT_DETAILS = "Importado em |c00A79EFF%s|r em |c00A79EFF%s|r";
...
L.TMB_TOOLTIP_TIER = "|c00FFFFFF Camada:|r %s";
...
--[[ VERSION /gl version ]]
L.VERSION_UPDATED = "|cff%sGargul|r agora está atualizado para |cff%sv%s|r";
...
L.VERSION_UPDATE_AVAILABLE = "v|c00A79EFFv%s|r está disponível em CurseForge/Wago. Você pode atualizar sem fechar o jogo, apenas certifique-se de /reload !";
...
L.PACKMULE_AUTOLOOT_PASS_PLACEHOLDER = "PASSAR";
L.PACKMULE_AUTOLOOT_GREED_PLACEHOLDER = "AMBIÇÃO";
L.PACKMULE_AUTOLOOT_NEED_PLACEHOLDER = "PRECISAR";
...
L.PACKMULE_AUTOLOOT_RANDOM_PLACEHOLDER = "ALEATÓRIO";
L.PACKMULE_AUTOLOOT_SELF_PLACEHOLDER = "AUTO";
...
L.GDKP_CREATE_SESSION_TYPE_LABEL = "Tipo de leilão (|c00A79EFFi|r para mais informações)";
L.GDKP_CREATE_SESSION_TYPE_INFO = [[

|c00A79EFFMulti-Leilão|r permite que você inicie lances em vários itens ao mesmo tempo, acelerando as coisas!
Siga as instruções após criar esta sessão para começar

Com |c00A79EFFSingle-Auction|r você escolhe leiloar itens únicos ou usar a fila

Selecionar |c00A79EFFMulti-Auction|r evita que itens descartados sejam adicionados à fila
Você pode misturar |c00A79EFFMulti-Auction|r com |c00A79EFFSingle-Auction|r e a fila, mas desaconselhamos fortemente isso
...
O formato é o seguinte: ItemID + mínimo ou incremento são obrigatórios. (|c00BE3333REQUER UM CABEÇALHO!!|r):
...
L.GDKP_LEDGER_LEGEND_BALANCE = "Saldo: |c0092FF000|r ? Você é quadrado! | |c00BE333330|r ? você deve %s 30g | |c00F7922E50|r ? %s lhe deve 50g";
L.GDKP_LEDGER_POT = "Pote total: %sg | Corte de gestão: %sg (%s%%) | Para distribuir: %sg";
L.GDKP_LEDGER_SESSION_BY = "|c00967FD2%s|r | Por %s%s | Em |c00967FD2%s|r";
...
L.GDKP_OVERVIEW_ADJUST_GOLD_DISABLED_TOOLTIP = "Você precisa de saque de chumbo ou mestre para ajustar o ouro.\nVocê não pode ajustar o ouro em sessões bloqueadas/excluídas";
L.GDKP_OVERVIEW_LEDGER_TOOLTIP = "Mostre uma visão geral completa do razão,\nideal para fins de captura de tela!";
...
L.GDKP_OVERVIEW_SESSION_DETAILS = "Por %s%s | Em |c00%s%s|r%s"; -- By name<guild> on date
...
L.GDKP_OVERVIEW_AUCTION_ENTRY = "%s pagou |cFF%s%s|r por\n%s"; -- i.e. Player paid 5000g for \n [Benediction]
L.GDKP_OVERVIEW_DELETED_ENTRY = "|cFFbe3333Excluído por|r %s\nMotivo: %s";
...
L.GDKP_OVERVIEW_DELETE_ENTRY_DISABLED_TOOLTIP = "Você precisa de saque principal ou mestre para excluir entradas.\nNão é possível excluir entradas em sessões bloqueadas/excluídas";
L.GDKP_OVERVIEW_RESTORE_ENTRY_DISABLED_TOOLTIP = "Você precisa de saque principal ou mestre para restaurar entradas.\nNão é possível restaurar entradas de sessões bloqueadas/excluídas";
L.GDKP_OVERVIEW_EDIT_ENTRY_DISABLED_TOOLTIP = "Você precisa de saque principal ou mestre para editar entradas.\nVocê não pode editar entradas excluídas ou entradas em sessões bloqueadas/excluídas";
...
L.GDKP_TUTORIAL_STEP_NEW = "Clique no botão |c00FFF569New|r abaixo para criar sua primeira sessão GDKP. Ele será exibido à esquerda quando criado";
L.GDKP_TUTORIAL_STEP_ACTIVATE = "Ative esta sessão clicando no botão |c00FFF569Enable|r abaixo!";
L.GDKP_TUTORIAL_STEP_READY = "Você está pronto para vender itens! |c00BE3333Leia todas as etapas abaixo com atenção e teste-as você mesmo (não há necessidade de estar em um ataque) antes de iniciar seu primeiro ataque ao GDKP!";
L.GDKP_TUTORIAL_STEP_AUCTION = "|c00FFF569%s|r um item para leiloar ou colocar um único item na fila"; -- %s holds the auction item hotkey (default ALT_CLICK)
L.GDKP_TUTORIAL_STEP_MULTI_AUCTION = "Quer leiloar vários itens de uma vez? Execute |c00FFF569/gl ma|r (ou |c00FFF569/gl multiauction|r) ou clique no ícone de leilão múltiplo no canto superior direito desta janela!";
L.GDKP_TUTORIAL_STEP_SELL = "Quer vender um item sem ninguém licitar? |c00FFF569%s|r em um item, escolha um vencedor e defina um preço!";
...
Comandos úteis:
- |c00FFF569/gdkp|r para abrir esta janela
- |c00FFF569/gl ma|r para abrir a janela de leilões múltiplos
- |c00FFF569/gl au|r para abrir o leiloeiro/fila de item único
- |c00FFF569/gl pm|r para configurar o saque automático
...
|c00967FD2GDKP Dados (vendidos %sx)|r
Última venda por: %s
Preço médio: %s
Lance mínimo: %s
Incremento: %s
...
L.GDKP_AUCTION_DETAILS_GOLD_ADDED = "|cFF%s%sg|r adicionado ao pote por %s\nNota: %s";
L.GDKP_AUCTION_DETAILS_GOLD_PAID_BY = "%s pagou |cFF%s%sg|r por\n%s";
L.GDKP_AUCTION_DETAILS_DELETED_REASON = "|cFFbe3333Excluído por|r %s\nMotivo: %s";
...
L.GDKP_BIDDER_AUTO_BID_CONFIRM = "Qual é o seu lance máximo? (Mínimo %s|c00FFF569g|r)";
...
|c00808080Há apenas uma desvantagem: para que as pessoas participem de um leilão em lote, os invasores precisarão de Gargul!|r
...
L.GDKP_MULTIAUCTION_CLIENT_REOPEN_INFO = "Janela de lances fechada, use |c00A79EFF/gl bid|r para reabri-la!";
...
Chamada final em TODOS os leilões

Inicie uma chamada final em todos os leilões que ainda não foram vendidos!
]];
...
L.GDKP_MULTIAUCTION_CLIENT_SOLD_INFO = "Este item foi vendido. Use o razão (|c00%s/gdkp|r) para fazer alterações!";
...
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_SOLD = "|c00%sVENDIDO|r para\n%s por |c00%s%sg|r";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_CLOSED = "|c00%sCLOSED\nSem lances|r";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_YOUR_BID = "Lance |c00%s%sg|r\nPor |c0092FF00VOCÊ!|r";
L.GDKP_MULTIAUCTION_CLIENT_AUCTION_STATUS_BID = "Lance |c00%s%sg|r\nPor %s";
...
L.GDKP_MUTATOR_HELP_TOOLTIP_BOTTOM = "Exemplo:\n|c00967FD2SELF,RL,HEALER|r";
...
L.GDKP_IMPORT_CUTS_INFO = "Você pode importar cortes de jogadores de seus próprios cálculos, como uma planilha do Google. softres GDKP etc.\n\nO formato é o seguinte (|c00BE3333INCLUDE THE HEADER!!|r):\n\n|c00BE3333Player,Gold|r|c00967FD2\nPlayer1,4000\nPlayer2,4125\nPlayer3,3998\n\n\n|r";
...
L.GDKP_TRADE_GIVEN_TO_LABEL = "Ouro |c00967FD2dado a|r %s";
L.GDKP_TRADE_RECEIVED_FROM_LABEL = "Ouro |c00967FD2 recebido de|r %s";
...
L.GDKP_MULTIAUCTION_AUCTIONEER_SESSION_DETAILS = "Sessão ativa do GDKP: |c00967FD2%s|r | Por %s%s | Em |c00967FD2%s|r";
...
Use o botão |c00A79EFFFFill from inventário|r abaixo para adicionar itens que ainda podem ser negociados à lista
...
|c00A79EFF%s|r itens para adicioná-los manualmente à lista
]];
...
--[[ BONUS FEATURES ]]
L.BONUS_AUTO_INVITE = "1. Convidar/classificar automaticamente grupos a partir da inscrição no raid! Clique abaixo ou use |c00A79EFF/gl gr|r";
L.BONUS_BOOSTED_ROLLS = "2. Recompense os jogadores por serem regulares ou por fazerem um esforço extra! Clique abaixo ou use |c00A79EFF/gl br|r";
L.BONUS_PLUSONES = "3. Gargul inclui mais um sistema de rastreamento! Clique abaixo ou use |c00A79EFF/gl po|r";

--[[ RAID GROUPS /gl gr ]]
L.RAIDGROUPS_EXPLANATION_LABEL_TOP = "Na grande caixa de edição abaixo você pode fornecer uma lista e: convidar todos, verificar quem está faltando, aplicar grupos e atribuir os tanques.\n\nVocê pode fornecer um link |c00FFF569Wowhead raid Composition|r:";
L.RAIDGROUPS_EXPLANATION_LABEL_BOTTOM = "um |c00FFF569Raid-Helper export|r (use a variante 'Grupos classificados verticalmente') ou um |c00FFF569Gargul composição de grupo|r CSV:";
...
L.ROLLING_IDENTICAL_ROLL_WARNING = "Atenção: foi encontrado outro lançamento idêntico que pode apontar para um empate|r\n\n";
...
L.MINIMAP_BUTTON_SETTING_INFO = "Alterar configurações no minimapa|r /gl";

--[[ ASSIGN WITH GARGUL ]]
L.ASSIGN_GARGUL_INFO = "Não se esqueça de usar Gargul\nse desejar exportar o saque mais tarde\n\n\n-- Clique com o botão direito para desativar esta janela --";

--[[ SHORTCUT KEYS ]]
L.KEYS_INFO = [[
Teclas de atalho de item Gargul

Implementação: |c00A79EFF%s|r
Prêmio: |c00A79EFF%s|r
