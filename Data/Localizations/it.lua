...
L["Edit"] = "Modificare";
L["Softres raid"] = "Raid Softres";
L["This item was awarded during the following Softres raid"] = "Questo oggetto è stato assegnato durante il seguente raid Softres";
L["Enable"] = "Abilitare";
L["Export"] = "Esportare";
L["Export session"] = "Esporta sessione";
...
L["Remove all bids and close all auctions?"] = "Rimuovere tutte le offerte bidsl e chiudere tutte le aste?";
...
L["Only for this character"] = "Solo per questo personaggio";
L["Other characters keep using the account-wide language"] = "Gli altri personaggi continueranno a usare la lingua a livello di account";
...
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Il tuo Gargul è troppo obsoleto per funzionare con gli altri. Aggiorna tramite CurseForge/Wago e |c00%s/reload|r!";
L["%s is trying to start a %s action, but their Gargul is too outdated. Ask them to update!"] = "%s sta cercando di avviare un'azione %s, ma il suo Gargul è troppo obsoleto. Chiedigli di aggiornare!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s è disponibile su CurseForge/Wago. Puoi aggiornare senza chiudere il gioco, assicurati solo di /reload!";
