...
L["|c00%sGargul v%s by Zhorax@Firemaw. Type |c00%s/gl or |c00%s/gargul to get started!"] = "|c00%sGargul v%s di Zhorax@Firemaw. Digita |c00%s/gl o |c00%s/gargul per iniziare!";
L["Hide"] = "Nascondere";
L["%H:%M"] = "%H:%M";
