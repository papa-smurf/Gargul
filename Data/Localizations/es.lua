...
El idioma actual de tu juego es '%s'
]];
L.LOCALE_CHANGE_NOTE = "Nota: puede cambiar la configuración regional en cualquier momento en la configuración o mediante |cff%s/gl locale|r";
