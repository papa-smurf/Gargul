...
L["Edit"] = "Editar";
L["Softres raid"] = "Raid de Softres";
L["This item was awarded during the following Softres raid"] = "Este objeto se asignó durante la siguiente raid de Softres";
L["Enable"] = "Permitir";
L["Export"] = "Exportar";
L["Export session"] = "Exportar sesión";
...
L["Your bid was lowered to %sg to match the auction's increment"] = "Su oferta se redujo a %sg para coincidir con el incremento de la subasta";
...
L["Remove all bids and close all auctions?"] = "¿Eliminar todas las ofertas y cerrar todas las subastas?";
...
L["Only for this character"] = "Solo para este personaje";
L["Other characters keep using the account-wide language"] = "Los demás personajes seguirán usando el idioma general de la cuenta";
...
Estas Softreserves parecen nombres mal escritos.
¿Vincularlas a estos jugadores de tu banda?]];
L["Choosing no imports the Softreserves unchanged"] = "Si eliges No, las Softreserves se importan sin cambios";
L["'%s' could be either '%s' or '%s'"] = "'%s' podría ser '%s' o '%s'";
...
L["Up-to-date:"] = "A hoy:";
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "¡Tu Gargul está demasiado desactualizado para funcionar con otros. Actualiza vía CurseForge/Wago y |c00%s/reload|r!";
L["%s is trying to start a %s action, but their Gargul is too outdated. Ask them to update!"] = "¡%s está intentando iniciar una acción de %s, pero su Gargul está demasiado desactualizado. Pídele que actualice!";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s está disponible en CurseForge/Wago. Puedes actualizar sin cerrar el juego, ¡solo asegúrate de /recargar!";
