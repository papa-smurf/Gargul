...
L.GDKP_EXPORT_INCLUDE_DISENCHANTED = "Incluir elementos desencantados";
...
L.MINIMUM = "Mínimo";
L.MINIMUM_ITEM_LEVEL = "Nivel mínimo de artículo";
...
L.TMB_IMPORT_TMB_GARGUL_INFO = "Cómo utilizar Gargul con ${source}";
...
L.VERSION_UPDATE_AVAILABLE = "|c00A79EFFv%s está disponible en CurseForge/Wago. Puedes actualizar sin cerrar el juego, ¡solo asegúrate de /recargar!";
