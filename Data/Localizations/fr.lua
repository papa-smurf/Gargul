...
L["Halt"] = "Arrêt";
L["Header"] = "En-tête";
L["|c00%sGargul v%s by Zhorax@Firemaw. Type |c00%s/gl or |c00%s/gargul to get started!"] = "|c00%sGargul v%s par Zhorax@Firemaw. Tapez |c00%s/gl ou |c00%s/gargul pour commencer !";
L["Hide"] = "Cacher";
L["%H:%M"] = "%H:%M";
