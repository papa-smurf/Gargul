...
L["This item was awarded during the following Softres raid"] = "Cet objet a été attribué lors du raid Softres suivant";
L["Enable"] = "Activer";
L["Export"] = "Exporter";
...
L["Only for this character"] = "Uniquement pour ce personnage";
L["Other characters keep using the account-wide language"] = "Les autres personnages continuent d'utiliser la langue du compte";
...
Ces Softreserves semblent correspondre à des noms mal orthographiés.
Les lier à ces joueurs de votre raid ?]];
L["Choosing no imports the Softreserves unchanged"] = "En choisissant Non, les Softreserves sont importées telles quelles";
L["'%s' could be either '%s' or '%s'"] = "'%s' pourrait être soit '%s', soit '%s'";
...
L["Outdated:"] = "Obsolète:";
L["Up-to-date:"] = "À jour:";
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "Votre Gargul est trop obsolète pour fonctionner avec les autres. Mettez à jour via CurseForge/Wago et |c00%s/reload|r !";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s est disponible sur CurseForge/Wago. Vous pouvez mettre à jour sans fermer votre jeu, assurez-vous simplement de /reload !";
