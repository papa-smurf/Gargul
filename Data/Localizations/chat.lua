...
L.CHAT = {
    ...
    deDE = {
        ...
        ["I removed %s from the pot"] = "Ich habe %sg aus dem Pott entfernt",
        ["I added %s back to the pot"] = "Ich habe %sg wieder in den Pott gegeben",
    ...
    zhCN = {
        ...
        ["I removed %s from the pot"] = "我从奖池中取出%sg",
        ["I added %s back to the pot"] = "我将 %sg 添加回奖池中",
    ...
    esES = {
        ...
        ["I removed %s from the pot"] = "Saqué %sg del bote",
        ["I added %s back to the pot"] = "Agregué %sg nuevamente al bote",
    ...
    frFR = {
        ...
        ["I removed %s from the pot"] = "J'ai supprimé %spo du pot",
        ["I added %s back to the pot"] = "J'ai rajouté %spo au pot",
    ...
    itIT = {
        ...
        ["I removed %s from the pot"] = "Ho rimosso %sg dal piatto",
        ["I added %s back to the pot"] = "Ho aggiunto %sg al piatto",
    ...
    koKR = {
        ...
        ["I removed %s from the pot"] = "냄비에서 %sg을(를) 제거했습니다",
        ["I added %s back to the pot"] = "냄비에 %sg을(를) 다시 추가했습니다",
    ...
    ptBR = {
        ...
        ["I removed %s from the pot"] = "Eu removi %sg do pote",
        ["I added %s back to the pot"] = "Eu adicionei %sg de volta ao pote",
    ...
    ruRU = {
        ...
        ["I removed %s from the pot"] = "Я удалил %sg из банка",
        ["I added %s back to the pot"] = "Я восстановил %sg в банке",
    ...
    zhTW = {
        ...
        ["I removed %s from the pot"] = "我從鍋中取出%sg",
        ["I added %s back to the pot"] = "我將 %sg 添加回鍋中",
