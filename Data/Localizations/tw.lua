...
L["Auto"] = "汽車";
L["Auto Roll"] = "自動Roll";
L["Enable Auto Roll"] = "啟用自動Roll";
L["Auto roll is active ( profile: %s )"] = "自動Roll已啟用 ( 配置: %s )";
L["now supports auto rolling: |c00%s/gl ar|r or |c00%s/gl autoroll|r"] = "Gargul現已支援自動Roll：|c00%s/gl ar|r 或 |c00%s/gl autoroll|r";
L["You automatically passed on %s"] = "你自動放棄了%s";
L["You automatically needed on %s"] = "你自動對%s需求了";
L["You automatically greeded on %s"] = "你自動對%s貪婪了";
L["Action"] = "操作";
L["Add"] = "添加";
L["Add item rules to automatically roll need, greed or pass when a roll is announced. Rules are stored per item ID. When you win an item, its rule is automatically set to pass."] = "添加物品規則，在宣布Roll時自動需求/貪婪/放棄。規則按物品ID存儲。贏得物品後規則自動設為放棄。";
L["Add item rules to automatically roll need, greed or pass when a Gargul roll is announced (does not work with group loot rolls). Rules are stored per item ID. When you win an item, its rule is automatically set to pass. Shift-click items, drag them into the box below or just start typing to search."] = "添加物品規則，在Gargul宣布Roll時自動需求/貪婪/放棄（不適用於團隊拾取Roll）。規則按物品ID存儲。贏得物品後規則自動設為放棄。Shift+點擊物品或將其拖入下方框內。";
L["Add rule"] = "添加規則";
L["4. Automatically roll need, greed or pass based on saved rules! Click below or use |c00A79EFF/gl ar"] = "4. 根據保存的規則自動需求/貪婪/放棄！點擊下方或使用 |c00A79EFF/gl ar";
L["Automatically roll need, greed or pass based on your saved rules when a Gargul roll is announced. Does not work with group loot rolls. Manage rules via the Auto Roll Rules section or |c00A79EFF/gl autoroll|r"] = "當Gargul宣布Roll時根據保存的規則自動需求/貪婪/放棄。不適用於團隊拾取Roll。通過自動Roll規則或 |c00A79EFF/gl autoroll|r 管理";
L["No rules yet. Add an item link and choose need, greed or pass."] = "暫無規則。添加物品連結並選擇需求/貪婪/放棄。";
L["Your rules"] = "您的規則";
L["Clear all"] = "全部清除";
L["Remove all rules from this profile"] = "從此配置文件中移除所有規則";
L["Remove all rules from this profile?"] = "從此配置文件中移除所有規則？";
L["Item link, ID, or type to search"] = "物品連結或ID";
L["Manage Auto Roll Rules"] = "管理自動Roll規則";
L["Invalid item link or ID"] = "無效的物品連結或ID";
L["(copy)"] = "（副本）";
L["A profile with that name already exists."] = "已存在同名配置文件。";
L["Copy profile"] = "複製配置";
L["Create profile"] = "創建配置";
L["Delete profile"] = "刪除配置";
L["Delete profile \"%s\"?"] = "刪除配置 \"%s\"？";
L["No profile"] = "無配置";
L["Profile name"] = "配置名稱";
L["Profile: "] = "配置：";
...
L["Disenchant"] = "分解";
L["Edit"] = "編輯";
L["Softres raid"] = "Softres 團隊";
L["This item was awarded during the following Softres raid"] = "此物品是在以下 Softres 團隊中分配的";
L["Enable"] = "啟用";
L["Export"] = "匯出";
L["Export session"] = "匯出會話";
...
L["Halt"] = "停";
L["Header"] = "標頭";
L["v%s. Type |c00967FD2/gl|r or |c00967FD2/gargul|r to get started!"] = "v%s。輸入 |c00967FD2/gl|r 或 |c00967FD2/gargul|r 開始！";
...
L["Only for this character"] = "僅適用於此角色";
L["Other characters keep using the account-wide language"] = "其他角色將繼續使用帳號通用的語言";
...
這些 Softreserve 看起來是拼錯的名字。
是否將它們連結到你團隊中的這些玩家？]];
L["Choosing no imports the Softreserves unchanged"] = "選擇“否”將原樣匯入這些 Softreserve";
...
L["Outdated:"] = "過時的：";
L["Up-to-date:"] = "最新：";
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "您的 Gargul 版本過舊，無法與他人協作。請透過 CurseForge/Wago 更新後 |c00%s/reload|r！";
L["%s is trying to start a %s action, but their Gargul is too outdated. Ask them to update!"] = "%s 正在嘗試啟動 %s 操作，但其 Gargul 版本過舊，請讓對方更新！";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s 可在 CurseForge/Wago 上使用。您可以在不關閉遊戲的情況下進行更新，只需確保 /reload ！";
