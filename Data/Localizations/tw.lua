...
L.LOCALE_ENUS = "埃內斯"; -- English (United States)
...
L.LOCALE_KOKR = "韓國KR"; -- Korean (Korea)
...
L.VERSION_UPDATE_AVAILABLE = "v|c00A79EFFv%s 可在 CurseForge/Wago 上使用。您可以在不關閉遊戲的情況下進行更新，只需確保 /reload ！";
