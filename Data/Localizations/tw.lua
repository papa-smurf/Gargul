...
L["Add item rules to automatically roll need, greed or pass when a Gargul roll is announced (does not work with group loot rolls). Rules are stored per item ID. When you win an item, its rule is automatically set to pass. Shift-click items or drag them into the box below."] = "添加物品規則，在Gargul宣布Roll時自動需求/貪婪/放棄（不適用於團隊拾取Roll）。規則按物品ID存儲。贏得物品後規則自動設為放棄。Shift+點擊物品或將其拖入下方框內。";
L["Add rule"] = "添加規則";
