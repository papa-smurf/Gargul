...
L.CHANGELOG_GETTING_STARTED = "Gargul 讓分裝變得超級簡單，點擊下面的按鈕即可開始！";
L.CHANGELOG_OPEN_GARGUL = "開啟 Gargul";
L.CHANGE_SCALE = "調整比例";
L.CHANNEL = "頻道";
L.CHANNEL_OFFICER = "幹部頻道";
L.CHANNEL_RAID_WARNING = "團隊警報(rw)頻道";
L.CHANNEL_WHISPER = "密語";
L.CLASSICPRIO_ABBR = "心肺復甦";
L.CLEAR = "清除"; -- As in clearing a window or data
L.CLOSE = "關閉";
L.CLOSE_ON_AWARD = "分裝時關閉";
L.CLOSE_ON_START = "開始倒數時關閉";
L.COMMUNICATION = "溝通";
...
L.ENABLE = "啟用";
L.EXPORT = "匯出";
L.EXPORT_DELETE_ALL_CONFIRM = "您確定要刪除全部的分裝紀錄嗎？這將刪除所有分裝數據並且無法回復！";
L.EXPORT_DELETE_DATE_CONFIRM = "您確定要刪除 %s 的所有資料嗎？這不能被回復！";
...
L.GARGUL = "Gargul";
L.GDKP = "GDKP";
L.GDKPS_ARE_NOT_ALLOWED = "此版本的魔獸世界不允許 GDKP";
L.GDKP_ACTIVATED = "GDKP 啟用！";
...
L.IMPORT = "匯入";
L.IMPORTED_AND_UPDATED_ON = "匯入於 |c00A79EFF%s |c00A79EFF%s，更新於 |c00A79EFF%s |c00A79EFF%s";
L.IMPORT_EXPLANATION = "您想匯入什麼類型的資料？";
L.IMPORT_SUCCESSFUL = "匯入成功";
L.INC = "公司";
...
L.LEDGER = "分類帳";
L.LEFT_SYMBOL = "<";
L.LM_OR_ASSIST_REQUIRED = "您需要成為分裝者或團隊助理！";
...
L.LOOTMASTER_CLEAR_SR_BUTTON = "清除 SR";
L.LOOTMASTER_CLEAR_TMB_BUTTON = "清除 TMB";
L.LOOTMASTER_DEFAULT_NOTE = "主天賦需求 /roll，或是副天賦需求 /roll 99";
L.LOOTMASTER_IMPORT_SR_BUTTON = "匯入 SR";
L.LOOTMASTER_IMPORT_TMB_BUTTON = "匯入 TMB";
L.LOOTMASTER_NOTICE_LABEL = "你被賦予了分裝者的角色";
L.LOOTMASTER_OPEN_LABEL = "自動開啟此視窗";
L.LOOTPRIORITY_CLEAR_SUCCESSFUL = "裝備優先度已成功清除";
L.LOOTPRIORITY_FORMAT_EXPLANATION = "提供以下格式的 prio CSV（每項 1 行）：id 或名稱 > prio1、equalprio > prio2 > 等";
L.LOOTPRIORITY_IMPORT_SUCCESSFUL = "裝備優先度匯入成功";
L.LOOTPRIORITY_INVALID_DATA = "提供的資料無效";
L.LOOTPRIORITY_INVALID_LINE = "第「%s」行中提供的資料無效：缺少項目 ID 或優先度";
L.LOOTPRIORITY_PROCESS_INCOMING = "正在嘗試處理來自 %s 的戰利品優先度";
L.LOOTPRIORITY_TOOLTIP_HEADER = "裝備優先度";
L.MAIL = "郵件";
L.MAILED = "郵寄";
...
L.MAXIMIZE = "最大化";
L.MIN = "最小";
L.MINIMAP_BUTTON_AWARDED = "分裝歷史";
L.MINIMAP_BUTTON_CUTS = "GDKP 削減";
L.MINIMAP_BUTTON_EXPORT = "匯出數據";
L.MINIMAP_BUTTON_GARGUL = "打開 Gargul";
L.MINIMAP_BUTTON_IMPORT = "匯入數據";
L.MINIMAP_BUTTON_LEDGER = "GDKP 紀錄";
L.MINIMAP_BUTTON_MULTIAUCTION = "多重拍賣";
L.MINIMAP_BUTTON_SETTING_INFO = "更改 /gl 小地圖中的設置";
L.MINIMIZE = "最小化";
L.MINIMIZE_ON_AWARD = "分裝時最小化";
L.MINIMIZE_ON_START = "開始倒數時最小化";
L.MINIMUM = "最低限度";
...
L.NO_OFFICER_PRIVILEGES = "你沒有幹部權限";
L.OFFSPEC_ABBR = "副天賦";
L.OK = "確定";
L.OPEN = "開啟";
...
L.PLUSONES_BROADCAST_CONFIRM = "您確定要將您的 +1 數據廣播給您的隊伍/團隊中的每個人嗎？";
L.PLUSONES_BROADCAST_PROCESS_START = "正在嘗試處理來自 %s 的傳入 +1 數據";
L.PLUSONES_CLEAR_CONFIRM = "%s 想要清除您的所有 +1 資料。清除所有資料？";
L.PLUSONES_IMPORT_CLEAR_CONFIRM = "您確定要清除現有的 +1 資料並匯入 %s 廣播的新資料嗎？";
...
L.RIGHT_SYMBOL = ">";
L.ROLL = "Roll";
L.ROLLING_AWARD_CONFIRM = "將 %s 分給 %s？";
L.ROLLING_CLOSE_ON_AWARD_LABEL = "分裝時關閉";
L.ROLLING_CLOSE_ON_START_LABEL = "開始倒數時關閉";
L.ROLLING_HOLD_SHIFT_TO_BYPASS_CONFIRMATION = "按住 shift 以略過分裝確認";
L.ROLLING_HOLD_SHIFT_TO_SHOW_CONFIRMATION = "按住 shift 以顯示分裝確認";
...
L.ROLLING_ITEM_WON_OS = "(副天賦)";
L.ROLLING_NOTE_LABEL = "訊息";
L.ROLLING_NO_ROLLOFF_WARNING = "無法停止 Roll 裝，無正在進行中的 Roll 裝";
L.ROLLING_PASS_BUTTON = "經過";
L.ROLLING_REOPEN_ROLL_COUNT = "Roll 數：%s";
L.ROLLING_REOPEN_TOOLTIP = "打開掠奪大師窗口";
L.ROLLING_ROLL_ACCEPTED = "接受 Roll 點！";
L.ROLLING_ROLL_IN_PROGRESS_WARNING = "目前正在進行 Roll 裝";
...
L.VERSION_INCOMPATIBLE_WARNING = "Gargul 版本過舊，更新後才能使用！";
L.VERSION_INVALID_WARNING = "Version:addRelease 中提供的版本字串無效";
L.VERSION_UPDATE = "更新 Gargul！";
