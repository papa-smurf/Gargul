...
L.GDKP_MULTIAUCTION_CLIENT_HIDE_INACTIVE = "隐藏非激活账单";
L.GDKP_MULTIAUCTION_CLIENT_HIDE_UNUSABLE = "隐藏不可用账单";
...
L.GDKP_MULTIAUCTION_CLIENT_SHOW_FAVORITES = "显示收藏";
L.GDKP_MULTIAUCTION_CLIENT_SHOW_INACTIVE = "显示非活动物品";
...
L.PACKMULE_AUTOLOOT_DISENCHANT_PLACEHOLDER = "分解";
L.PACKMULE_AUTOLOOT_GREED_PLACEHOLDER = "贪婪";
L.PACKMULE_AUTOLOOT_IGNORE_PLACEHOLDER = "忽略";
L.PACKMULE_AUTOLOOT_NEED_PLACEHOLDER = "需求";
L.PACKMULE_AUTOLOOT_PASS_PLACEHOLDER = "跳过";
L.PACKMULE_AUTOLOOT_RANDOM_PLACEHOLDER = "随机";
