...
L["4. Automatically roll need, greed or pass based on saved rules! Click below or use |c00A79EFF/gl ar"] = "4. 根据保存的规则自动需求/贪婪/放弃！点击下方或使用 |c00A79EFF/gl ar";
L["Action"] = "操作";
L["Add"] = "添加";
...
L["Auto roll is active ( profile: %s )"] = "自动Roll已启用 ( 配置: %s )";
L["You automatically passed on %s"] = "你自动放弃了%s";
L["You automatically needed on %s"] = "你自动对%s需求了";
L["You automatically greeded on %s"] = "你自动对%s贪婪了";
L["Automatically roll need, greed or pass based on your saved rules when a Gargul roll is announced. Does not work with group loot rolls. Manage rules via the Auto Roll Rules section or |c00A79EFF/gl autoroll|r"] = "当Gargul宣布Roll时根据保存的规则自动需求/贪婪/放弃。不适用于团队拾取Roll。通过自动Roll规则或 |c00A79EFF/gl autoroll|r 管理";
L["now supports auto rolling: |c00%s/gl ar|r or |c00%s/gl autoroll|r"] = "Gargul现已支持自动Roll：|c00%s/gl ar|r 或 |c00%s/gl autoroll|r";
...
L["No rules yet. Add an item link and choose need, greed or pass."] = "暂无规则。添加物品链接并选择需求/贪婪/放弃。";
...
L["Disenchant"] = "分解";
L["Edit"] = "编辑";
L["Softres raid"] = "Softres 团队";
L["This item was awarded during the following Softres raid"] = "此物品是在以下 Softres 团队中分配的";
L["Enable"] = "激活";
L["Export"] = "导出";
...
L["Your rules"] = "您的规则";
L["Clear all"] = "全部清除";
L["Remove all rules from this profile"] = "从此配置文件中移除所有规则";
L["Remove all rules from this profile?"] = "从此配置文件中移除所有规则？";
...
L["Manage Auto Roll Rules"] = "管理自动Roll规则";
...
L["Halt"] = "暂停";
L["Header"] = "标题";
L["v%s. Type |c00967FD2/gl|r or |c00967FD2/gargul|r to get started!"] = "v%s。输入 |c00967FD2/gl|r 或 |c00967FD2/gargul|r 开始！";
...
L["Only for this character"] = "仅适用于此角色";
L["Other characters keep using the account-wide language"] = "其他角色将继续使用账号通用的语言";
...
L["Invalid item link or ID"] = "无效的物品链接或ID";
L["(BR: %s)"] = "（BR：%s）";
...
L["Outdated:"] = "过时的：";
L["Up-to-date:"] = "最新：";
L["Your Gargul is too outdated to work with others. Update via CurseForge/Wago and |c00%s/reload|r!"] = "您的 Gargul 版本过旧，无法与他人协作。请通过 CurseForge/Wago 更新后 |c00%s/reload|r！";
...
L["|c00A79EFFv%s is available on CurseForge/Wago. You can update without closing your game, just be sure to |c00%s/reload|r!"] = "|c00A79EFFv%s 可在 CurseForge/Wago 上使用。您可以在不关闭游戏的情况下进行更新，只需确保 /reload ！";
