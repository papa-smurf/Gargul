...
L.LOCALE_DEDE = "德语（德国）"; -- German (Germany)
L.LOCALE_ENUS = "英语（美国）"; -- English (United States)
L.LOCALE_ESES = "西班牙语（西班牙）"; -- Spanish (Spain)
L.LOCALE_ESMX = "西班牙语（墨西哥）"; -- Spanish (Mexico)
L.LOCALE_FRFR = "法语（法国）"; -- French (France)
L.LOCALE_ITIT = "意大利语（意大利）"; -- Italian (Italy)
L.LOCALE_KOKR = "韩语（韩国）"; -- Korean (Korea)
...
L.LOCALE_PTBR = "葡萄牙语（巴西）"; -- Portuguese (Brazil)
L.LOCALE_RURU = "俄语（俄罗斯）"; -- Russian (Russia)
L.LOCALE_ZHCN = "简体中文（中国）"; -- Chinese (Simplified, PRC)
L.LOCALE_ZHTW = "繁体中文（台湾）"; -- Chinese (Traditional, Taiwan)
...
L.QUALITY_POOR = "垃圾";
L.QUALITY_RARE = "稀有";
L.QUALITY_UNCOMMON = "精良";
L.QUEUE = "队列";
L.RAIDERS = "攻略";
L.RAIDGROUPS_ATTENDANCE_BUTTON = "谁失踪了";
L.RAIDGROUPS_ATTENDANCE_BUTTON_TOOLTIP = "显示缺失的成员姓名";
L.RAIDGROUPS_DISBAND_BUTTON = "解散团队";
L.RAIDGROUPS_DISBAND_BUTTON_TOOLTIP = "解散你的团队";
...
L.RAIDGROUPS_NO_RAID_WARNING = "你需要参加团队！";
...
L.ROLLING_INVALID_START_DATA_WARNING = "为开始 Roll 点提供的数据无效！";
L.ROLLING_ITEM_WON_BR_COST = "（BR：%s）";
L.ROLLING_ITEM_WON_GIVEN = "（给出的项目：是）";
L.ROLLING_ITEM_WON_NOT_GIVEN = "（给出的项目：无）";
L.ROLLING_ITEM_WON_OS = "（副天赋）";
L.ROLLING_NOTE_LABEL = "笔记";
L.ROLLING_NO_ROLLOFF_WARNING = "无法停止滚滚，没有正在进行滚滚";
L.ROLLING_PASS_BUTTON = "放弃";
L.ROLLING_REOPEN_ROLL_COUNT = "Roll 点数：%s";
L.ROLLING_REOPEN_TOOLTIP = "打开战利品分配者窗口";
L.ROLLING_ROLL_ACCEPTED = "Roll 点已被接受！";
L.ROLLING_ROLL_IN_PROGRESS_WARNING = "当前正在进行 Roll 点";
...
L.SETTINGS_COUNTDOWN_IN_RAID_WARNING = "宣布团队警告倒计时";
L.SETTINGS_INCOMING_BIDS_IN_RAID_WARNING = "在团队警告中宣布收到的投标";
L.SETTINGS_RESET_UI = "重置 Gargul UI";
L.SETTINGS_WHISPER_BID_TOO_LOW = "如果出价太低，则对投标人密语";
L.SILVER_INDICATOR = "s";
L.SKIP = "跳过";
L.SOFTRES = "软保留";
L.SOFTRES_ABBR = "SR";
L.SOFTRES_BROADCAST_CONFIRM = "您确定要将您的软保留数据广播给您的队伍/团队中的每个人吗？";
L.SOFTRES_BROADCAST_PROCESS_FAILED = "无法处理从 %s 收到的 SoftRes 数据";
L.SOFTRES_CLEAR_CONFIRM = "您确定要清除所有现有的软保留数据吗？";
L.SOFTRES_EVERYONE_RESERVED = "每个人都填满了软保留";
...
L.SOFTRES_IMPORT_INVALID = "提供的软保留数据无效";
...
L.SOFTRES_IMPORT_SUCCESSFUL = "软保留导入成功";
...
L.SOFTRES_OVERVIEW_HARDRESERVES_LABEL = "单击此处查看硬保留信息";
L.SOFTRES_OVERVIEW_NO_HARDRESERVES = "没有硬性保留的项目";
L.SOFTRES_OVERVIEW_NO_HARDRESERVE_INFO = "没有可用的硬保留信息";
...
L.SOFTRES_TOOLTIP_HARD_RESERVED = "此物品为硬保留";
...
L.TMB_CLEAR_RAIDER_DATA = "清除团队成员数据";
L.TMB_CLEAR_RAIDER_DATA_CONFIRM = "清除所有团队成员的 TMB 数据？";
...
L.TMB_TOOLTIP_OFFSPEC_INDICATION = "（副天赋）";
...
L.VERSION_UPDATED = "|c00%sGargul 现已更新至 |c00%sv%s";
