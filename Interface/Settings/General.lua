...
function General:draw(Parent)
    ...
    local Checkboxes = {
        ...
        },
        {
            ...
            description = "Thank you for contributing! The more players using Gargul the more motivated its developers become. Spread the word by prepending messages generated by the add-on with 'Gargul: '",
