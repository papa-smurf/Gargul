...
GL.Interface.Identity = {
    ...
    --[[ ================== J0E  ================== ]]
    ["2304869063-665692004"] = {
        id = "joe",
        url = "https://discord.gg/JoesPuggers",
        urlInfo = "Join our Discord server to learn more about Joe's Puggers!",
        tooltip = "Joe's Puggers - is what it is",
        cutMailSubject = L.CUT_MAIL_SUBJECT,
        Realms = { "firemaw", },

        ---@return Frame
        ledger = function()
            local Identity = GL.Interface.Identity["2304869063-665692004"];
    ...
    ["956571599-3715333585"] = {
        ...
        ---@return Frame
        ledger = function()
            local Identity = GL.Interface.Identity["956571599-3715333585"];
...
--[[ J0E ALIASES ]]
Identity["751637125-2708428672"] = Identity["2304869063-665692004"];
Identity["2772805393-2420320966"] = Identity["2304869063-665692004"];
